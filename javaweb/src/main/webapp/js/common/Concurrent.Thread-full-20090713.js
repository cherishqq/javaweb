	...
	with (function() {
		with (Math) {
			...
			return function() {
				...
				/*******************************************************************************************************
				 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this file are subject to
				 * the Mozilla Public License Version 1.1 (the "License"); you may not use this file except in
				 ...
				 * limitations under the License. The Original Code is Math.ToInteger module. The Initial Developer of
				 * the Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2006
				 * the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of this file
				 * may be used under the terms of either the GNU General Public License Version 2 or later (the "GPL"),
				 * or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the
				 * provisions of the GPL or the LGPL are applicable instead of those above. If you wish to allow use of
				 * your version of this file only under the terms of either the GPL or the LGPL, and not to allow others
				 * to use your version of this file under the terms of the MPL, indicate your decision by deleting the
...
(function() {
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (this.Data.Stack === undefined)
		this.Data.Stack = undefined;
	with (function() {
		with (Data) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Data.Stack module. The Initial Developer of the
				 * Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2006 the
				 * Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of this file may
				 * be used under the terms of either the GNU General Public License Version 2 or later (the "GPL"), or
				 * the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the provisions
				 * of the GPL or the LGPL are applicable instead of those above. If you wish to allow use of your
				 * version of this file only under the terms of either the GPL or the LGPL, and not to allow others to
				 * use your version of this file under the terms of the MPL, indicate your decision by deleting the
				 * provisions above and replace them with the notice and other provisions required by the GPL or the
				 * LGPL. If you do not delete the provisions above, a recipient may use your version of this file under
				 * the terms of any one of the MPL, the GPL or the LGPL. ***** END LICENSE BLOCK *****
				 */
...
(function() {
	if (!this.Util || (typeof this.Util != 'object' && typeof this.Util != 'function'))
		this.Util = new Object();
	if (!this.Util.Arrayize || (typeof this.Util.Arrayize != 'object' && typeof this.Util.Arrayize != 'function'))
		this.Util.Arrayize = new Object();
	if (this.Util.Arrayize.arrayize === undefined)
		this.Util.Arrayize.arrayize = undefined;
	with (function() {
		with (Util.Arrayize) {
...
(function() {
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Data.Cons.Cell === undefined)
		this.Data.Cons.Cell = undefined;
	if (this.Data.Cons.Nil === undefined)
		this.Data.Cons.Nil = undefined;
	if (this.Data.Cons.nil === undefined)
		this.Data.Cons.nil = undefined;
	if (this.Data.Cons.cons === undefined)
		this.Data.Cons.cons = undefined;
	if (this.Data.Cons.car === undefined)
		this.Data.Cons.car = undefined;
	if (this.Data.Cons.cdr === undefined)
		this.Data.Cons.cdr = undefined;
	with (function() {
		with (Data.Cons) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Data.Cons code. The Initial Developer of the
				 * Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2006-2007
				 * the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of this file
				 * may be used under the terms of either the GNU General Public License Version 2 or later (the "GPL"),
				 * or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the
				 * provisions of the GPL or the LGPL are applicable instead of those above. If you wish to allow use of
				...
				proto.toLocaleString = function() {
					return "(" + (this.car == null ? String(this.car) : this.car.toLocaleString) + " . "
				...
				proto.toString = proto.toLocaleString = function() {
					return "nil";
				};
...
(function() {
	if (!this.WebBrowser || (typeof this.WebBrowser != 'object' && typeof this.WebBrowser != 'function'))
		this.WebBrowser = new Object();
	if (!this.WebBrowser.ScriptExecuter
			|| (typeof this.WebBrowser.ScriptExecuter != 'object' && typeof this.WebBrowser.ScriptExecuter != 'function'))
		this.WebBrowser.ScriptExecuter = new Object();
	if (this.WebBrowser.ScriptExecuter.register === undefined)
		this.WebBrowser.ScriptExecuter.register = undefined;
	if (this.WebBrowser.ScriptExecuter.exec === undefined)
		this.WebBrowser.ScriptExecuter.exec = undefined;
	with (function() {
			...
			return function() {
				...
				function register(type, exec) {
					if (typeof exec != "function")
						throw new TypeError("function required, but got: " + exec);
...
(function() {
	if (!this.WebBrowser || (typeof this.WebBrowser != 'object' && typeof this.WebBrowser != 'function'))
		this.WebBrowser = new Object();
	if (!this.WebBrowser.GUI || (typeof this.WebBrowser.GUI != 'object' && typeof this.WebBrowser.GUI != 'function'))
		this.WebBrowser.GUI = new Object();
	if (!this.WebBrowser.GUI.Event
			|| (typeof this.WebBrowser.GUI.Event != 'object' && typeof this.WebBrowser.GUI.Event != 'function'))
		this.WebBrowser.GUI.Event = new Object();
	if (this.WebBrowser.GUI.Event.attach === undefined)
		this.WebBrowser.GUI.Event.attach = undefined;
	if (this.WebBrowser.GUI.Event.detach === undefined)
		this.WebBrowser.GUI.Event.detach = undefined;
	with (function() {
			...
			return function() {
				...
				function detach(element, type, listener, useCapture) {
					if (arguments.length === 1 && typeof element === "number") {
						...
						for (var i in registry) {
							var reg = registry[i];
							if (reg.element === element && reg.type === type && reg.listener === listener
				...
				function detach_aux(element, type, listener, useCapture) {
					return element.removeEventListener
							...
							: element.detachEvent ? element.detachEvent("on" + type, listener) : delete element["on"
									+ type];
				}
...
(function() {
	if (!this.JSON || (typeof this.JSON != 'object' && typeof this.JSON != 'function'))
		this.JSON = new Object();
	if (this.JSON.dump === undefined)
		this.JSON.dump = undefined;
	with (function() {
		with (JSON) {
			...
			return function() {
				...
				String.prototype[DUMPER] = function(opts) {
					return opts.deflate ? "new String(" + dump_string(this.toString()) + ")" : dump_string(this
							.toString());
				};

				Boolean.prototype[DUMPER] = function(opts) {
					return opts.deflate ? "new Boolean(" + this.toString() + ")" : this.toString();
				};

				Number.prototype[DUMPER] = function(opts) {
					return opts.deflate ? "new Number(" + this.toString() + ")" : this.toString();
				};

				Date.prototype[DUMPER] = function(opts) {
					return opts.deflate ? "new Date(" + this.valueOf() + ")" : dump_string(this.toString());
				};

				RegExp.prototype[DUMPER] = function(opts) {
					return opts.deflate ? this.toString() : dump_string(this.toString());
				};
...
(function() {
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (!this.Data.Functional.Loop
			|| (typeof this.Data.Functional.Loop != 'object' && typeof this.Data.Functional.Loop != 'function'))
		this.Data.Functional.Loop = new Object();
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Data.Functional.discontinue === undefined)
		this.Data.Functional.discontinue = undefined;
	if (this.Data.Functional.DiscontinueException === undefined)
		this.Data.Functional.DiscontinueException = undefined;
	if (this.Data.Functional.ignore === undefined)
		this.Data.Functional.ignore = undefined;
	if (this.Data.Functional.IgnoreException === undefined)
		this.Data.Functional.IgnoreException = undefined;
	if (this.Data.Functional.return_list === undefined)
		this.Data.Functional.return_list = undefined;
	if (this.Data.Functional.ReturnListException === undefined)
		this.Data.Functional.ReturnListException = undefined;
	if (this.Data.Functional.Loop.EndOfLoopException === undefined)
		this.Data.Functional.Loop.EndOfLoopException = undefined;
	if (this.Data.Functional.Loop.wrap_for_forEach === undefined)
		this.Data.Functional.Loop.wrap_for_forEach = undefined;
	if (this.Data.Functional.Loop.wrap_for_fold === undefined)
		this.Data.Functional.Loop.wrap_for_fold = undefined;
	if (this.Data.Functional.Loop.wrap_for_map === undefined)
		this.Data.Functional.Loop.wrap_for_map = undefined;
	with (function() {
		with (Data.Functional.Loop) {
			with (Data.Functional) {
				...
				return function() {
					...
					/***************************************************************************************************
					 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this file are subject
					 * to the Mozilla Public License Version 1.1 (the "License"); you may not use this file except in
					 * compliance with the License. You may obtain a copy of the License at http://www.mozilla.org/MPL/
					 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF
					 * ANY KIND, either express or implied. See the License for the specific language governing rights
					 * and limitations under the License. The Original Code is Data.Functional code. The Initial
					 * Developer of the Original Code is Daisuke Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2005-2007 the Initial Developer. All Rights Reserved. Contributor(s):
					...
					function wrap_for_forEach(t, f) {
						if (typeof f != "function")
							throw new TypeError("argument to forEach must be function");
						return function(v) {
							try {
								f.call(t, v);
							} catch (e) {
					...
					function wrap_for_fold(t, f, s) {
						if (typeof f != "function")
							throw new TypeError("argument to fold must be function");
						return function(v) {
							try {
					...
					function wrap_for_map(t, f, a) {
						if (typeof f != "function")
							throw new TypeError("argument to map must be function");
						if (typeof a != "function")
							throw new TypeError("the third argument to wrap_for_map must be function");
						return function(v) {
							try {
					...
					return {
						...
						wrap_for_forEach : wrap_for_forEach,
						wrap_for_map : wrap_for_map,
						ignore : ignore,
						discontinue : discontinue,
						ReturnListException : ReturnListException,
						wrap_for_fold : wrap_for_fold,
						return_list : return_list,
						IgnoreException : IgnoreException,
						EndOfLoopException : EndOfLoopException
					};
				}();
			}
		}
			...
			return function() {
				...
				Function.prototype.extend = function extend(init, props) {
					if (typeof init !== "function")
						throw new TypeError("function is expected: " + init);
					if (props == null)
						props = {};
...
(function() {
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
		this.Data.Error = new Object();
	if (this.Data.Error.Error === undefined)
		this.Data.Error.Error = undefined;
	if (this.Data.Error.Exception === undefined)
		this.Data.Error.Exception = undefined;
	with (function() {
		with (Data.Error) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Data.Error module. The Initial Developer of the
				 * Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2005-2006
				 * the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of this file
				 * may be used under the terms of either the GNU General Public License Version 2 or later (the "GPL"),
				 * or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the
				 * provisions of the GPL or the LGPL are applicable instead of those above. If you wish to allow use of
				...
				var Error = GLOBAL.Error.extend(function($super, message) {
					$super(message);
				}, {
				...
				var Exception = GLOBAL.Error.extend(function($super, message) {
					$super(message);
				}, {
...
(function() {
	...
	if (!this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
		this.Data.Error = new Object();
	if (this.Data.Error.UnimplementedMethodError === undefined)
		this.Data.Error.UnimplementedMethodError = undefined;
	with (function() {
		with (Data.Error) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Data.Error.UnimplementedMethodError. The Initial
				 * Developer of the Original Code is Daisuke Maki. Portions created by the Initial Developer are
				 * Copyright (C) 2005-2006 the Initial Developer. All Rights Reserved. Contributor(s): Alternatively,
				 * the contents of this file may be used under the terms of either the GNU General Public License
				 * Version 2 or later (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the
				 * "LGPL"), in which case the provisions of the GPL or the LGPL are applicable instead of those above.
				 * If you wish to allow use of your version of this file only under the terms of either the GPL or the
				 * LGPL, and not to allow others to use your version of this file under the terms of the MPL, indicate
				 * your decision by deleting the provisions above and replace them with the notice and other provisions
				 * required by the GPL or the LGPL. If you do not delete the provisions above, a recipient may use your
				 * version of this file under the terms of any one of the MPL, the GPL or the LGPL. ***** END LICENSE
				 * BLOCK *****
				 */

				NAMESPACE = 'Data.Error';

				var UnimplementedMethodError = Error.extend(function($super, method, invocant, message) {
...
(function() {
	...
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Iterator || (typeof this.Data.Iterator != 'object' && typeof this.Data.Iterator != 'function'))
		this.Data.Iterator = new Object();
	if (this.Data.Iterator.NoSuchElementError === undefined)
		this.Data.Iterator.NoSuchElementError = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Iterator) {
				...
				return function() {
					 ...
					 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF
					 * ANY KIND, either express or implied. See the License for the specific language governing rights
					 * and limitations under the License. The Original Code is Data.Iterator code. The Initial Developer
					 * of the Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C)
					 * 2006 the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of
					 * this file may be used under the terms of either the GNU General Public License Version 2 or later
					 * (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which
					 * case the provisions of the GPL or the LGPL are applicable instead of those above. If you wish to
					 * allow use of your version of this file only under the terms of either the GPL or the LGPL, and
					 * not to allow others to use your version of this file under the terms of the MPL, indicate your
					 * decision by deleting the provisions above and replace them with the notice and other provisions
					 * required by the GPL or the LGPL. If you do not delete the provisions above, a recipient may use
					 * your version of this file under the terms of any one of the MPL, the GPL or the LGPL. ***** END
					 * LICENSE BLOCK *****
					 */

					NAMESPACE = 'Data.Iterator';

					var NoSuchElementError = Error.extend(function($super, message) {
						$super(message);
					}, {
...
(function() {
	...
	if (!this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
		this.Data.Error = new Object();
	if (this.Data.Error.IllegalStateError === undefined)
		this.Data.Error.IllegalStateError = undefined;
	with (function() {
		with (Data.Error) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Data.Error.IllegalStateError module. The Initial
				 * Developer of the Original Code is Daisuke Maki. Portions created by the Initial Developer are
				 * Copyright (C) 2006 the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the
				 * contents of this file may be used under the terms of either the GNU General Public License Version 2
				 * or later (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in
				 * which case the provisions of the GPL or the LGPL are applicable instead of those above. If you wish
				 * to allow use of your version of this file only under the terms of either the GPL or the LGPL, and not
				 * to allow others to use your version of this file under the terms of the MPL, indicate your decision
				 * by deleting the provisions above and replace them with the notice and other provisions required by
				 * the GPL or the LGPL. If you do not delete the provisions above, a recipient may use your version of
				 * this file under the terms of any one of the MPL, the GPL or the LGPL. ***** END LICENSE BLOCK *****
				 */

				NAMESPACE = 'Data.Error';

				var IllegalStateError = Error.extend(function($super, message) {
					$super(message);
				}, {
...
(function() {
	...
	if (!this.Data.Iterator || (typeof this.Data.Iterator != 'object' && typeof this.Data.Iterator != 'function'))
		this.Data.Iterator = new Object();
	if (this.Data.Iterator.Iterator === undefined)
		this.Data.Iterator.Iterator = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Iterator) {
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Data.Functional.Enumerable === undefined)
		this.Data.Functional.Enumerable = undefined;
	if (this.Data.Functional.EmptyEnumerationError === undefined)
		this.Data.Functional.EmptyEnumerationError = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Functional.Loop) {
				with (Data.Functional) {
					...
					return function() {
						...
						/***********************************************************************************************
						 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this file are
						 ...
						 * IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the
						 * specific language governing rights and limitations under the License. The Original Code is
						 * Data.Functional code. The Initial Developer of the Original Code is Daisuke Maki. Portions
						 * created by the Initial Developer are Copyright (C) 2005-2007 the Initial Developer. All
						 * Rights Reserved. Contributor(s): Alternatively, the contents of this file may be used under
						 * the terms of either the GNU General Public License Version 2 or later (the "GPL"), or the GNU
						 * Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the provisions
						 * of the GPL or the LGPL are applicable instead of those above. If you wish to allow use of
						 * your version of this file only under the terms of either the GPL or the LGPL, and not to
						 * allow others to use your version of this file under the terms of the MPL, indicate your
						 * decision by deleting the provisions above and replace them with the notice and other
						 * provisions required by the GPL or the LGPL. If you do not delete the provisions above, a
						 * recipient may use your version of this file under the terms of any one of the MPL, the GPL or
						 * the LGPL. ***** END LICENSE BLOCK *****
						 */
						...
						proto.fold1 = function(f) {
							...
							if (it.isTail())
								throw new EmptyEnumerationError();
							var s = it.value();
							it = it.next();
							f = wrap_for_fold(this, f, s);
						...
						var EmptyEnumerationError = Error.extend(function($super, message) {
							$super(message);
						}, {
						...
						return {
							EmptyEnumerationError : EmptyEnumerationError,
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Data.Functional.Collection === undefined)
		this.Data.Functional.Collection = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Functional.Loop) {
				with (Data.Functional) {
...
(function() {
	...
	if (!this.Data.Iterator || (typeof this.Data.Iterator != 'object' && typeof this.Data.Iterator != 'function'))
		this.Data.Iterator = new Object();
	if (this.Data.Iterator.BidirectionalIterator === undefined)
		this.Data.Iterator.BidirectionalIterator = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Iterator) {
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Data.Functional.List === undefined)
		this.Data.Functional.List = undefined;
	with (function() {
		with (Math) {
			with (Data.Functional.Loop) {
				with (Data.Functional) {
					...
					return function() {
						...
						proto.slice = function(start, end) {
							if (!(start instanceof List.Iterator && end instanceof List.Iterator
									&& start.isBoundTo(this) && end.isBoundTo(this) && start.constructor === end.constructor)) // one might be reverse-iterator even though the other is iterator.
							{
								try {
						...
						proto.foldr = function(f, s) {
							var g = wrap_for_fold(this, function(x, y) {
								return f.call(this, y, x);
							}, s);
							for (var it = this.reverseHead(); !it.isTail(); it = it.next()) {
								try {
									s = g(it.value());
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Data.Functional.Set === undefined)
		this.Data.Functional.Set = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Iterator) {
				with (Data.Functional) {
					...
					return function() {
						...
						proto.containsAll = function( /* variable args */) {
							for (var i = 0; i < arguments.length; i++) {
								...
								if (e instanceof Array) {
									if (!this.contains.apply(this, e))
										return false;
								} else if (e instanceof Collection) {
									var self = this;
									if (!e.all(function(it) {
										return self.contains(it);
									}))
										return false;
								} else {
									if (!this.contains(e))
						...
						proto.removeAt = function(it) {
							if (!(it instanceof Iterator))
								throw new TypeError("the argument is not of type Data.Iterator.Iterator");
							if (!it.isBoundTo(this))
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (!this.Data.Functional.List
			|| (typeof this.Data.Functional.List != 'object' && typeof this.Data.Functional.List != 'function'))
		this.Data.Functional.List = new Object();
	if (this.Data.Functional.List.Iterator === undefined)
		this.Data.Functional.List.Iterator = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Iterator) {
				with (Data.Functional.List) {
					...
					return function() {
						...
						proto.distance = proto.compareTo = function(that) {
							if (!(that instanceof Iterator))
								return undefined;
...
(function() {
	...
	if (!this.Data.Functional.List
			|| (typeof this.Data.Functional.List != 'object' && typeof this.Data.Functional.List != 'function'))
		this.Data.Functional.List = new Object();
	if (this.Data.Functional.List.ReverseIterator === undefined)
		this.Data.Functional.List.ReverseIterator = undefined;
	with (function() {
		with (Data.Functional.List) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Data.Functional code. The Initial Developer of
				 * the Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C)
				 * 2005-2007 the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of
				 * this file may be used under the terms of either the GNU General Public License Version 2 or later
				 * (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which
				 * case the provisions of the GPL or the LGPL are applicable instead of those above. If you wish to
				 * allow use of your version of this file only under the terms of either the GPL or the LGPL, and not to
				 * allow others to use your version of this file under the terms of the MPL, indicate your decision by
				 * deleting the provisions above and replace them with the notice and other provisions required by the
				 * GPL or the LGPL. If you do not delete the provisions above, a recipient may use your version of this
				 * file under the terms of any one of the MPL, the GPL or the LGPL. ***** END LICENSE BLOCK *****
				 */
				...
				proto.equals = function(that) {
					if (!(that instanceof ReverseIterator))
						return false;
...
(function() {
	with (function() {
		...
		return function() {
			...
			/***********************************************************************************************************
			 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this file are subject to the
			 * Mozilla Public License Version 1.1 (the "License"); you may not use this file except in compliance with
			 * the License. You may obtain a copy of the License at http://www.mozilla.org/MPL/ Software distributed
			 * under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or
			 * implied. See the License for the specific language governing rights and limitations under the License.
			 * The Original Code is Data.Functional code. The Initial Developer of the Original Code is Daisuke Maki.
			 * Portions created by the Initial Developer are Copyright (C) 2005-2007 the Initial Developer. All Rights
			 * Reserved. Contributor(s): Alternatively, the contents of this file may be used under the terms of either
			 * the GNU General Public License Version 2 or later (the "GPL"), or the GNU Lesser General Public License
			 * Version 2.1 or later (the "LGPL"), in which case the provisions of the GPL or the LGPL are applicable
			 * instead of those above. If you wish to allow use of your version of this file only under the terms of
			 * either the GPL or the LGPL, and not to allow others to use your version of this file under the terms of
			 * the MPL, indicate your decision by deleting the provisions above and replace them with the notice and
			 * other provisions required by the GPL or the LGPL. If you do not delete the provisions above, a recipient
			 * may use your version of this file under the terms of any one of the MPL, the GPL or the LGPL. ***** END
			 * LICENSE BLOCK *****
			 */
				...
				with (Data.Functional.Loop) {
					with (Data.Functional) {
						...
						return function() {
							...
							/*******************************************************************************************
							 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this file are
							 * subject to the Mozilla Public License Version 1.1 (the "License"); you may not use this
							 ...
							 * for the specific language governing rights and limitations under the License. The
							 * Original Code is Data.Functional code. The Initial Developer of the Original Code is
							 * Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2005-2007 the
							 * Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of
							 * this file may be used under the terms of either the GNU General Public License Version 2
							 * or later (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the
							 * "LGPL"), in which case the provisions of the GPL or the LGPL are applicable instead of
							 * those above. If you wish to allow use of your version of this file only under the terms
							 * of either the GPL or the LGPL, and not to allow others to use your version of this file
							 * under the terms of the MPL, indicate your decision by deleting the provisions above and
							 * replace them with the notice and other provisions required by the GPL or the LGPL. If you
							 * do not delete the provisions above, a recipient may use your version of this file under
							 * the terms of any one of the MPL, the GPL or the LGPL. ***** END LICENSE BLOCK *****
							 */
							...
							proto.set = function(it, v) {
								...
								if (n < 0)
									n += this.length;
								if (n < 0)
									throw new RangeError("`" + it + "' is too small.");
								if (n >= this.length)
									throw new RangeError("`" + it + "' is too large.");
								return this[n] = v;
							};
							...
							proto.copy = proto.toArray = function() {
								var a = [];
							...
							proto.fold = proto.foldl = function(f, s) {
								f = wrap_for_fold(this, f, s);
								for (var i = 0; i < this.length; i++) {
									try {
										s = f(this[i]);
							...
							proto.fold1 = proto.foldl1 = function(f) {
								if (this.length == 0)
									throw new EmptyEnumerationError();
								var s = this[0];
								f = wrap_for_fold(this, f, s);
							...
							proto.slice = function(start, end) {
								if ((start instanceof Iterator && end instanceof Iterator || start instanceof ReverseIterator
										&& end instanceof ReverseIterator)
							...
							proto.isHead = function() {
								return ToInteger(this._pos) <= 0 || this._arr.length == 0;
							};

							proto.isTail = function() {
								return ToInteger(this._pos) >= this._arr.length || this._arr.length == 0;
							};
							...
							proto.value = function() {
								...
								if (this.isHead())
									...
									return this._arr[ToInteger(this._pos)];
							};
							...
							proto.assign = function(v) {
								if (this.isTail())
									return this.insert();
								if (this.isHead())
									return this._arr[0] = v;
								else
									return this._arr[ToInteger(this._pos)] = v;
							};
							...
							proto.insert = function(v) {
								...
								if (i <= 0)
									...
									i = min(i, this._arr.length);
								return this._arr.insertAt(i, v);
							};

							proto.remove = function() {
								if (this.isTail())
									throw new IllegalStateError("can't remove at the tail of list");
								else if (this.isHead())
									return this._arr.aplice(0, 1)[0];
								else
							...
							proto.next = function() {
								if (this.isTail())
									throw new NoSuchElement("no next element");
								if (this.isHead())
									return new this.constructor(this._arr, 1);
								else
							...
							proto.previous = function() {
								if (this.isHead())
									throw new NoSuchElement("no previous element");
								if (this.isTail())
									return new this.constructor(this._arr, this._arr.length - 1);
								else
									return new this.constructor(this._arr, this._pos - 1);
							};

							proto.compareTo = proto.distance = function(that) {
								if (!(that instanceof this.constructor))
									return undefined;
								if (this._arr !== that._arr)
									return undefined;
							...
							for (var i in Iterator.prototype) {
								if (Iterator.prototype.hasOwnProperty(i) && typeof Iterator.prototype[i] == "function") {
							...
							proto.value = function() {
								...
								if (this.isHead())
									...
									return this._arr[this._arr.length - 1 - ToInteger(this._pos)];
							};
							...
							proto.assign = function(v) {
								if (this.isTail())
									this.insert(v);
								if (this.isHead())
									return this._arr[this._arr.length - 1] = v;
								else
									return this._arr[this._arr.length - 1 - ToInteger(this._pos)] = v;
							};
							...
							proto.remove = function() {
								if (this.isTail())
									throw new IllegalStateError("can't remove at the tail of list");
								if (this.isHead())
									return this._arr.splice(this._arr.length - 1, 1)[0];
								else
									return this._arr.splice(this._arr.length - 1 - ToInteger(this._pos), 1)[0];
							};
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Data.Cons.list === undefined)
		this.Data.Cons.list = undefined;
	if (this.Data.Cons.InsertAtHeadError === undefined)
		this.Data.Cons.InsertAtHeadError = undefined;
	if (this.Data.Cons.RemoveHeadError === undefined)
		this.Data.Cons.RemoveHeadError = undefined;
	with (function() {
		with (Math) {
			with (Data.Error) {
				with (Data.Iterator) {
						...
						with (Data.Functional) {
							with (Data.Cons) {
								...
								return function() {
									...
									/***********************************************************************************
									 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this
									 * file are subject to the Mozilla Public License Version 1.1 (the "License"); you
									 ...
									 * and limitations under the License. The Original Code is Data.Cons code. The
									 * Initial Developer of the Original Code is Daisuke Maki. Portions created by the
									 * Initial Developer are Copyright (C) 2007 the Initial Developer. All Rights
									 * Reserved. Contributor(s): Alternatively, the contents of this file may be used
									 * under the terms of either the GNU General Public License Version 2 or later (the
									 * "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the
									 * "LGPL"), in which case the provisions of the GPL or the LGPL are applicable
									 * instead of those above. If you wish to allow use of your version of this file
									 * only under the terms of either the GPL or the LGPL, and not to allow others to
									 * use your version of this file under the terms of the MPL, indicate your decision
									 * by deleting the provisions above and replace them with the notice and other
									 * provisions required by the GPL or the LGPL. If you do not delete the provisions
									 * above, a recipient may use your version of this file under the terms of any one
									...
									proto.iterator = proto.head = function(n) {
										n = ToInteger(n);
										if (n < 0)
											return this.tail(-n);
										try {
									...
									proto.foldr = function(f, s) {
										return this.reverse().foldl(function(x, y) {
											return f.call(this, y, x);
										}, s);
									};

									proto.foldr1 = function(f) {
										return this.reverse().foldl1(function(x, y) {
											return f.call(this, y, x);
										});
									};
									...
									proto.remove = function() {
										if (this.isHead())
											throw new RemoveHeadError();
										if (this.isTail())
											throw new IllegalStateError("can't remove at tail");
									...
									proto.next = function() {
										if (this.isTail())
											throw new NoSuchElementError("no next element");
										return new Iterator(this._head, this._cell.cdr, this);
									};

									proto.previous = function() {
										if (this.isHead())
											throw new NoSuchElementError("no previous element");
										return this._prev;
									};

									proto.equals = function(that) {
										return that instanceof Iterator && that.isBoundTo(this._head)
												&& this._cell === that._cell;
									};

									proto.compareTo = proto.distance = function(that) {
										if (!(that instanceof Iterator && that.isBoundTo(this._head)))
											return undefined;
									...
									var InsertAtHeadError = Error.extend(function($super, message) {
										$super(message);
									}, {
									...
									var RemoveHeadError = Error.extend(function($super, message) {
										$super(message);
									}, {
									...
									return {
										InsertAtHeadError : InsertAtHeadError,
										RemoveHeadError : RemoveHeadError,
										list : list
									};
								}();
							}
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Data.LinkedList === undefined)
		this.Data.LinkedList = undefined;
	with (function() {
		with (Math) {
			with (Data.Error) {
				with (Data.Iterator) {
						...
						with (Data.Functional) {
							with (Data) {
								...
								return function() {
									 ...
									 * License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either
									 * express or implied. See the License for the specific language governing rights
									 * and limitations under the License. The Original Code is Data.LinkedList module.
									 * The Initial Developer of the Original Code is Daisuke Maki. Portions created by
									 * the Initial Developer are Copyright (C) 2005-2007 the Initial Developer. All
									 * Rights Reserved. Contributor(s): Alternatively, the contents of this file may be
									 * used under the terms of either the GNU General Public License Version 2 or later
									 * (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the
									 * "LGPL"), in which case the provisions of the GPL or the LGPL are applicable
									 * instead of those above. If you wish to allow use of your version of this file
									 * only under the terms of either the GPL or the LGPL, and not to allow others to
									 * use your version of this file under the terms of the MPL, indicate your decision
									...
									proto.equals = function(that) {
										if (!(that instanceof Iterator && that.isBoundTo(this._top)))
											return false;
										validate(this);
										validate(that);
...
(function() {
	...
	if (!this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
		this.Data.Error = new Object();
	if (!this.Concurrent || (typeof this.Concurrent != 'object' && typeof this.Concurrent != 'function'))
		this.Concurrent = new Object();
	if (this.Concurrent.Thread === undefined)
		this.Concurrent.Thread = undefined;
	with (function() {
		with (Data.Error) {
			with (Concurrent) {
				...
				return function() {
					 ...
					 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF
					 * ANY KIND, either express or implied. See the License for the specific language governing rights
					 * and limitations under the License. The Original Code is Concurrent.Thread code. The Initial
					 * Developer of the Original Code is Daisuke Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2006-2007 the Initial Developer. All Rights Reserved. Contributor(s):
					 * Alternatively, the contents of this file may be used under the terms of either the GNU General
					 * Public License Version 2 or later (the "GPL"), or the GNU Lesser General Public License Version
					 * 2.1 or later (the "LGPL"), in which case the provisions of the GPL or the LGPL are applicable
					 * instead of those above. If you wish to allow use of your version of this file only under the
					...
					function doNext() {
						...
						try {
							...
							do {
								try {
									triplet = triplet.continuation.procedure.call(triplet.continuation.this_val,
										triplet.ret_val);
								} catch (e) {
						...
						if (triplet.timeout < 0) { /* Do nothing. */
							...
							standBy.call(this, triplet.timeout);
						}
					}
					...
					Thread.create = function(f /* , ... */) {
						if (typeof f != "function")
							throw new TypeError("can't create new thread from non-function value");
						if (typeof f.$Concurrent_Thread_compiled !== "function")
							f = this.compile(f);
					...
					var KillException = Thread.KillException = Exception.extend(function($super, message) {
						$super(message);
					}, {
					...
					var NotAliveError = Thread.NotAliveError = Error.extend(function($super, message) {
						$super(message);
					}, {
					...
					proto.call.$Concurrent_Thread_compiled = function(this_val, args, cont) {
						if (typeof this_val.$Concurrent_Thread_compiled == "function") {
							return this_val.$Concurrent_Thread_compiled(args[0], Array.prototype.slice.call(args, 1,
									args.length), cont);
						} else {
							return {
								continuation : cont,
					...
					proto.async = function(this_val, args) {
						if (typeof this.$Concurrent_Thread_compiled != "function")
							throw new Error("this is not a compiled function");
						if (args === void 0)
							args = []; // IE6 does not allow null or undefined-value as the second argument of Function.prototype.apply. That does not conform to ECMA262-3!
						return new THREAD(this.$Concurrent_Thread_compiled(this_val, args, initial_continuation));
					};
...
(function() {
	if (!this.Concurrent || (typeof this.Concurrent != 'object' && typeof this.Concurrent != 'function'))
		this.Concurrent = new Object();
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (!this.Concurrent.Thread.Http
			|| (typeof this.Concurrent.Thread.Http != 'object' && typeof this.Concurrent.Thread.Http != 'function'))
		this.Concurrent.Thread.Http = new Object();
	if (this.Concurrent.Thread.Http.send === undefined)
		this.Concurrent.Thread.Http.send = undefined;
	if (this.Concurrent.Thread.Http.get === undefined)
		this.Concurrent.Thread.Http.get = undefined;
	if (this.Concurrent.Thread.Http.post === undefined)
		this.Concurrent.Thread.Http.post = undefined;
	with (function() {
		with (Concurrent.Thread.Http) {
			...
			return function() {
				 ...
				 * Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY
				 * KIND, either express or implied. See the License for the specific language governing rights and
				 * limitations under the License. The Original Code is Concurrent.Thread code. The Initial Developer of
				 * the Original Code is Daisuke Maki. Portions created by the Initial Developer are Copyright (C)
				 * 2006-2007 the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of
				 * this file may be used under the terms of either the GNU General Public License Version 2 or later
				 * (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which
				 * case the provisions of the GPL or the LGPL are applicable instead of those above. If you wish to
				 * allow use of your version of this file only under the terms of either the GPL or the LGPL, and not to
						...
						var ex_handler = {
							procedure : function(e) {
								if (e === LoadedException) {
									...
									} // IE less than 7 does not support "abort".
									return {
				...
				get.$Concurrent_Thread_compiled = function($this, $args, $cont) {
					return send.$Concurrent_Thread_compiled(null, ["GET", $args[0], $args[1], null], $cont);
				}
				...
				post.$Concurrent_Thread_compiled = function($this, $args, $cont) {
					...
					return send.$Concurrent_Thread_compiled(null, ["POST", url, body, headers], $cont);
				};
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (!this.Data.Cons.Util || (typeof this.Data.Cons.Util != 'object' && typeof this.Data.Cons.Util != 'function'))
		this.Data.Cons.Util = new Object();
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
		this.Data.Error = new Object();
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Data.Cons.Util.last === undefined)
		this.Data.Cons.Util.last = undefined;
	if (this.Data.Cons.Util.adder === undefined)
		this.Data.Cons.Util.adder = undefined;
	if (this.Data.Cons.Util.concat === undefined)
		this.Data.Cons.Util.concat = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Cons) {
				with (Data.Cons.Util) {
					...
					return function() {
						 ...
						 * IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the
						 * specific language governing rights and limitations under the License. The Original Code is
						 * Data.Cons code. The Initial Developer of the Original Code is Daisuke Maki. Portions created
						 * by the Initial Developer are Copyright (C) 2007 the Initial Developer. All Rights Reserved.
						 * Contributor(s): Alternatively, the contents of this file may be used under the terms of
						 * either the GNU General Public License Version 2 or later (the "GPL"), or the GNU Lesser
						 * General Public License Version 2.1 or later (the "LGPL"), in which case the provisions of the
						 * GPL or the LGPL are applicable instead of those above. If you wish to allow use of your
						 * version of this file only under the terms of either the GPL or the LGPL, and not to allow
						 * others to use your version of this file under the terms of the MPL, indicate your decision by
						 * deleting the provisions above and replace them with the notice and other provisions required
						 * by the GPL or the LGPL. If you do not delete the provisions above, a recipient may use your
						 * version of this file under the terms of any one of the MPL, the GPL or the LGPL. ***** END
						 * LICENSE BLOCK *****
						 */
						...
						function last(c) {
							if (!(c instanceof Cell))
								throw new TypeError("argument is not cons-list");
							if (c.isNil())
								return c;
						...
						function adder(c) {
							c = last(c);
							if (c.isNil())
								throw new IllegalStateError("can't append to nil");
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (this.Concurrent.Thread.Compiler.isAlpha === undefined)
		this.Concurrent.Thread.Compiler.isAlpha = undefined;
	if (this.Concurrent.Thread.Compiler.isDigit === undefined)
		this.Concurrent.Thread.Compiler.isDigit = undefined;
	if (this.Concurrent.Thread.Compiler.isHexDigit === undefined)
		this.Concurrent.Thread.Compiler.isHexDigit = undefined;
	if (this.Concurrent.Thread.Compiler.isLineTerminator === undefined)
		this.Concurrent.Thread.Compiler.isLineTerminator = undefined;
	if (this.Concurrent.Thread.Compiler.isSpace === undefined)
		this.Concurrent.Thread.Compiler.isSpace = undefined;
	if (this.Concurrent.Thread.Compiler.isFormatChar === undefined)
		this.Concurrent.Thread.Compiler.isFormatChar = undefined;
	if (this.Concurrent.Thread.Compiler.isIdentifierStart === undefined)
		this.Concurrent.Thread.Compiler.isIdentifierStart = undefined;
	if (this.Concurrent.Thread.Compiler.isIdentifierPart === undefined)
		this.Concurrent.Thread.Compiler.isIdentifierPart = undefined;
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				...
				function isAlpha(c) {
					...
					return c <= 0x5A ? 0x41 <= c : 0x61 <= c && c <= 0x7A;
					// #/generated#
				}
				...
				function isHexDigit(c) {
					...
					return c <= 0x46 ? c <= 0x39 ? 0x30 <= c : 0x41 <= c : 0x61 <= c && c <= 0x66;
					// #/generated#
				}
				...
				function isSpace(c) {
					...
					if (c <= 255) {
						...
						return c <= 0x180E ? c <= 0xA0 ? c <= 0x20 ? 0x20 <= c : 0xA0 <= c : c <= 0x1680
								? 0x1680 <= c
								: 0x180E <= c : c <= 0x202F ? c <= 0x200A ? 0x2000 <= c : 0x202F <= c : c <= 0x205F
								? 0x205F <= c
								: c === 0x3000;
						// #/generated#
					}
				...
				function isFormatChar(c) {
					c = c.charCodeAt(0);
					if (c <= 127)
						return false; // optimization for ASCII characters
					// the following code is derived from the Unicode category Cf based on:
					// http://www.unicode.org/Public/UNIDATA/extracted/DerivedGeneralCategory.txt
					// #generated# Last update: Tue, 01 Aug 2006 01:50:39 +0900
					return c <= 0x202E
							? c <= 0x70F ? c <= 0x603 ? c <= 0xAD ? 0xAD <= c : 0x600 <= c : c <= 0x6DD
									? 0x6DD <= c
									: 0x70F <= c : c <= 0x200F ? c <= 0x17B5 ? 0x17B4 <= c : 0x200B <= c : 0x202A <= c
							: c <= 0xFFFB ? c <= 0x206F ? c <= 0x2063 ? 0x2060 <= c : 0x206A <= c : c <= 0xFEFF
									? 0xFEFF <= c
									: 0xFFF9 <= c : c <= 0xE0001
									? c <= 0x1D17A ? 0x1D173 <= c : 0xE0001 <= c
									: 0xE0020 <= c && c <= 0xE007F;
					// #/generated#
				}
				...
				function isIdentifierStart(c) {
					...
					return c <= 0x1731 ? c <= 0xB95 ? c <= 0x961 ? c <= 0x587 ? c <= 0x37D ? c <= 0xD6 ? c <= 0xAA
							? c <= 0x7A ? c <= 0x5A ? 0x41 <= c : 0x61 <= c : 0xAA <= c
							: c <= 0xBA ? c <= 0xB5 ? 0xB5 <= c : 0xBA <= c : 0xC0 <= c : c <= 0x2D1 ? c <= 0x2C1
							? c <= 0xF6 ? 0xD8 <= c : 0xF8 <= c
							: 0x2C6 <= c : c <= 0x2EE ? c <= 0x2E4 ? 0x2E0 <= c : 0x2EE <= c : 0x37A <= c : c <= 0x3F5
							? c <= 0x38C ? c <= 0x38A ? c <= 0x386 ? 0x386 <= c : 0x388 <= c : 0x38C <= c : c <= 0x3CE
									? c <= 0x3A1 ? 0x38E <= c : 0x3A3 <= c
									: 0x3D0 <= c
							: c <= 0x556 ? c <= 0x513 ? c <= 0x481 ? 0x3F7 <= c : 0x48A <= c : 0x531 <= c : c <= 0x559
									? 0x559 <= c
									: 0x561 <= c : c <= 0x710 ? c <= 0x6D3
							? c <= 0x63A ? c <= 0x5F2 ? c <= 0x5EA ? 0x5D0 <= c : 0x5F0 <= c : 0x621 <= c : c <= 0x66F
									? c <= 0x64A ? 0x640 <= c : 0x66E <= c
									: 0x671 <= c
							: c <= 0x6EF ? c <= 0x6E6 ? c <= 0x6D5 ? 0x6D5 <= c : 0x6E5 <= c : 0x6EE <= c : c <= 0x6FF
									? c <= 0x6FC ? 0x6FA <= c : 0x6FF <= c
									: 0x710 <= c : c <= 0x7F5
							? c <= 0x7A5 ? c <= 0x76D ? c <= 0x72F ? 0x712 <= c : 0x74D <= c : 0x780 <= c : c <= 0x7EA
									? c <= 0x7B1 ? 0x7B1 <= c : 0x7CA <= c
									: 0x7F4 <= c
							: c <= 0x93D ? c <= 0x939 ? c <= 0x7FA ? 0x7FA <= c : 0x904 <= c : 0x93D <= c : c <= 0x950
									? 0x950 <= c
									: 0x958 <= c : c <= 0xA8D ? c <= 0x9F1 ? c <= 0x9B2 ? c <= 0x990 ? c <= 0x98C
							? c <= 0x97F ? 0x97B <= c : 0x985 <= c
							: 0x98F <= c : c <= 0x9B0 ? c <= 0x9A8 ? 0x993 <= c : 0x9AA <= c : 0x9B2 <= c : c <= 0x9CE
							? c <= 0x9BD ? c <= 0x9B9 ? 0x9B6 <= c : 0x9BD <= c : 0x9CE <= c
							: c <= 0x9E1 ? c <= 0x9DD ? 0x9DC <= c : 0x9DF <= c : 0x9F0 <= c : c <= 0xA36 ? c <= 0xA28
							? c <= 0xA10 ? c <= 0xA0A ? 0xA05 <= c : 0xA0F <= c : 0xA13 <= c
							: c <= 0xA33 ? c <= 0xA30 ? 0xA2A <= c : 0xA32 <= c : 0xA35 <= c : c <= 0xA5E ? c <= 0xA5C
							? c <= 0xA39 ? 0xA38 <= c : 0xA59 <= c
							: 0xA5E <= c : c <= 0xA74 ? 0xA72 <= c : 0xA85 <= c : c <= 0xB28 ? c <= 0xABD ? c <= 0xAB0
							? c <= 0xAA8 ? c <= 0xA91 ? 0xA8F <= c : 0xA93 <= c : 0xAAA <= c
							: c <= 0xAB9 ? c <= 0xAB3 ? 0xAB2 <= c : 0xAB5 <= c : 0xABD <= c : c <= 0xB0C ? c <= 0xAE1
							? c <= 0xAD0 ? 0xAD0 <= c : 0xAE0 <= c
							: 0xB05 <= c : c <= 0xB10 ? 0xB0F <= c : 0xB13 <= c : c <= 0xB61 ? c <= 0xB39 ? c <= 0xB33
							? c <= 0xB30 ? 0xB2A <= c : 0xB32 <= c
							: 0xB35 <= c : c <= 0xB5D ? c <= 0xB3D ? 0xB3D <= c : 0xB5C <= c : 0xB5F <= c : c <= 0xB8A
							? c <= 0xB83 ? c <= 0xB71 ? 0xB71 <= c : 0xB83 <= c : 0xB85 <= c
							: c <= 0xB90 ? 0xB8E <= c : 0xB92 <= c : c <= 0xEB0 ? c <= 0xD28 ? c <= 0xC61 ? c <= 0xBB9
							? c <= 0xB9F ? c <= 0xB9C ? c <= 0xB9A ? 0xB99 <= c : 0xB9C <= c : 0xB9E <= c : c <= 0xBAA
									? c <= 0xBA4 ? 0xBA3 <= c : 0xBA8 <= c
									: 0xBAE <= c
							: c <= 0xC28 ? c <= 0xC10 ? c <= 0xC0C ? 0xC05 <= c : 0xC0E <= c : 0xC12 <= c : c <= 0xC39
									? c <= 0xC33 ? 0xC2A <= c : 0xC35 <= c
									: 0xC60 <= c : c <= 0xCBD
							? c <= 0xCA8 ? c <= 0xC90 ? c <= 0xC8C ? 0xC85 <= c : 0xC8E <= c : 0xC92 <= c : c <= 0xCB9
									? c <= 0xCB3 ? 0xCAA <= c : 0xCB5 <= c
									: 0xCBD <= c
							: c <= 0xD0C ? c <= 0xCE1 ? c <= 0xCDE ? 0xCDE <= c : 0xCE0 <= c : 0xD05 <= c : c <= 0xD10
									? 0xD0E <= c
									: 0xD12 <= c : c <= 0xE82 ? c <= 0xDBD
							? c <= 0xD96 ? c <= 0xD61 ? c <= 0xD39 ? 0xD2A <= c : 0xD60 <= c : 0xD85 <= c : c <= 0xDBB
									? c <= 0xDB1 ? 0xD9A <= c : 0xDB3 <= c
									: 0xDBD <= c
							: c <= 0xE33 ? c <= 0xE30 ? c <= 0xDC6 ? 0xDC0 <= c : 0xE01 <= c : 0xE32 <= c : c <= 0xE46
									? 0xE40 <= c
									: 0xE81 <= c : c <= 0xE9F
							? c <= 0xE8A ? c <= 0xE88 ? c <= 0xE84 ? 0xE84 <= c : 0xE87 <= c : 0xE8A <= c : c <= 0xE97
									? c <= 0xE8D ? 0xE8D <= c : 0xE94 <= c
									: 0xE99 <= c
							: c <= 0xEA7 ? c <= 0xEA5 ? c <= 0xEA3 ? 0xEA1 <= c : 0xEA5 <= c : 0xEA7 <= c : c <= 0xEAB
									? 0xEAA <= c
									: 0xEAD <= c : c <= 0x1258 ? c <= 0x102A ? c <= 0xF00 ? c <= 0xEC4 ? c <= 0xEBD
							? c <= 0xEB3 ? 0xEB2 <= c : 0xEBD <= c
							: 0xEC0 <= c : c <= 0xEDD ? c <= 0xEC6 ? 0xEC6 <= c : 0xEDC <= c : 0xF00 <= c : c <= 0xF8B
							? c <= 0xF6A ? c <= 0xF47 ? 0xF40 <= c : 0xF49 <= c : 0xF88 <= c
							: c <= 0x1027 ? c <= 0x1021 ? 0x1000 <= c : 0x1023 <= c : 0x1029 <= c : c <= 0x11A2
							? c <= 0x10FA
									? c <= 0x10C5 ? c <= 0x1055 ? 0x1050 <= c : 0x10A0 <= c : 0x10D0 <= c
									: c <= 0x1159 ? c <= 0x10FC ? 0x10FC <= c : 0x1100 <= c : 0x115F <= c
							: c <= 0x124D
									? c <= 0x1248 ? c <= 0x11F9 ? 0x11A8 <= c : 0x1200 <= c : 0x124A <= c
									: c <= 0x1256 ? 0x1250 <= c : 0x1258 <= c : c <= 0x1315 ? c <= 0x12BE ? c <= 0x128D
							? c <= 0x1288 ? c <= 0x125D ? 0x125A <= c : 0x1260 <= c : 0x128A <= c
							: c <= 0x12B5 ? c <= 0x12B0 ? 0x1290 <= c : 0x12B2 <= c : 0x12B8 <= c : c <= 0x12D6
							? c <= 0x12C5 ? c <= 0x12C0 ? 0x12C0 <= c : 0x12C2 <= c : 0x12C8 <= c
							: c <= 0x1310 ? 0x12D8 <= c : 0x1312 <= c : c <= 0x169A
							? c <= 0x13F4
									? c <= 0x138F ? c <= 0x135A ? 0x1318 <= c : 0x1380 <= c : 0x13A0 <= c
									: c <= 0x1676 ? c <= 0x166C ? 0x1401 <= c : 0x166F <= c : 0x1681 <= c
							: c <= 0x170C
									? c <= 0x16F0 ? c <= 0x16EA ? 0x16A0 <= c : 0x16EE <= c : 0x1700 <= c
									: c <= 0x1711 ? 0x170E <= c : 0x1720 <= c : c <= 0xA805 ? c <= 0x2115 ? c <= 0x1F4D
							? c <= 0x19A9
									? c <= 0x17DC ? c <= 0x1770 ? c <= 0x176C
											? c <= 0x1751 ? 0x1740 <= c : 0x1760 <= c
											: 0x176E <= c : c <= 0x17D7
											? c <= 0x17B3 ? 0x1780 <= c : 0x17D7 <= c
											: 0x17DC <= c : c <= 0x191C ? c <= 0x18A8 ? c <= 0x1877
											? 0x1820 <= c
											: 0x1880 <= c : 0x1900 <= c : c <= 0x1974 ? c <= 0x196D
											? 0x1950 <= c
											: 0x1970 <= c : 0x1980 <= c
									: c <= 0x1E9B ? c <= 0x1B33 ? c <= 0x1A16
											? c <= 0x19C7 ? 0x19C1 <= c : 0x1A00 <= c
											: 0x1B05 <= c : c <= 0x1DBF
											? c <= 0x1B4B ? 0x1B45 <= c : 0x1D00 <= c
											: 0x1E00 <= c : c <= 0x1F1D ? c <= 0x1F15 ? c <= 0x1EF9
											? 0x1EA0 <= c
											: 0x1F00 <= c : 0x1F18 <= c : c <= 0x1F45 ? 0x1F20 <= c : 0x1F48 <= c
							: c <= 0x1FD3 ? c <= 0x1FB4 ? c <= 0x1F5B ? c <= 0x1F59 ? c <= 0x1F57
									? 0x1F50 <= c
									: 0x1F59 <= c : 0x1F5B <= c : c <= 0x1F7D
									? c <= 0x1F5D ? 0x1F5D <= c : 0x1F5F <= c
									: 0x1F80 <= c : c <= 0x1FC4 ? c <= 0x1FBE
									? c <= 0x1FBC ? 0x1FB6 <= c : 0x1FBE <= c
									: 0x1FC2 <= c : c <= 0x1FCC ? 0x1FC6 <= c : 0x1FD0 <= c : c <= 0x207F ? c <= 0x1FF4
									? c <= 0x1FEC ? c <= 0x1FDB ? 0x1FD6 <= c : 0x1FE0 <= c : 0x1FF2 <= c
									: c <= 0x2071 ? c <= 0x1FFC ? 0x1FF6 <= c : 0x2071 <= c : 0x207F <= c : c <= 0x2107
									? c <= 0x2102 ? c <= 0x2094 ? 0x2090 <= c : 0x2102 <= c : 0x2107 <= c
									: c <= 0x2113 ? 0x210A <= c : 0x2115 <= c : c <= 0x2DBE ? c <= 0x2C5E ? c <= 0x2139
							? c <= 0x2126
									? c <= 0x2124 ? c <= 0x211D ? 0x2119 <= c : 0x2124 <= c : 0x2126 <= c
									: c <= 0x212D ? c <= 0x2128 ? 0x2128 <= c : 0x212A <= c : 0x212F <= c
							: c <= 0x214E
									? c <= 0x2149 ? c <= 0x213F ? 0x213C <= c : 0x2145 <= c : 0x214E <= c
									: c <= 0x2C2E ? c <= 0x2184 ? 0x2160 <= c : 0x2C00 <= c : 0x2C30 <= c : c <= 0x2D6F
							? c <= 0x2CE4
									? c <= 0x2C77 ? c <= 0x2C6C ? 0x2C60 <= c : 0x2C74 <= c : 0x2C80 <= c
									: c <= 0x2D65 ? c <= 0x2D25 ? 0x2D00 <= c : 0x2D30 <= c : 0x2D6F <= c
							: c <= 0x2DAE
									? c <= 0x2DA6 ? c <= 0x2D96 ? 0x2D80 <= c : 0x2DA0 <= c : 0x2DA8 <= c
									: c <= 0x2DB6 ? 0x2DB0 <= c : 0x2DB8 <= c : c <= 0x30FA ? c <= 0x3029 ? c <= 0x2DD6
							? c <= 0x2DCE ? c <= 0x2DC6 ? 0x2DC0 <= c : 0x2DC8 <= c : 0x2DD0 <= c
							: c <= 0x3007 ? c <= 0x2DDE ? 0x2DD8 <= c : 0x3005 <= c : 0x3021 <= c : c <= 0x3096
							? c <= 0x303C ? c <= 0x3035 ? 0x3031 <= c : 0x3038 <= c : 0x3041 <= c
							: c <= 0x309F ? 0x309D <= c : 0x30A1 <= c : c <= 0x4DB5
							? c <= 0x318E
									? c <= 0x312C ? c <= 0x30FF ? 0x30FC <= c : 0x3105 <= c : 0x3131 <= c
									: c <= 0x31FF ? c <= 0x31B7 ? 0x31A0 <= c : 0x31F0 <= c : 0x3400 <= c
							: c <= 0xA71A
									? c <= 0xA48C ? c <= 0x9FBB ? 0x4E00 <= c : 0xA000 <= c : 0xA717 <= c
									: c <= 0xA801 ? 0xA800 <= c : 0xA803 <= c : c <= 0x1049D
							? c <= 0xFEFC
									? c <= 0xFB36 ? c <= 0xFA6A ? c <= 0xA873 ? c <= 0xA822 ? c <= 0xA80A
											? 0xA807 <= c
											: 0xA80C <= c : 0xA840 <= c : c <= 0xFA2D ? c <= 0xD7A3
											? 0xAC00 <= c
											: 0xF900 <= c : 0xFA30 <= c : c <= 0xFB17 ? c <= 0xFB06 ? c <= 0xFAD9
											? 0xFA70 <= c
											: 0xFB00 <= c : 0xFB13 <= c : c <= 0xFB28 ? c <= 0xFB1D
											? 0xFB1D <= c
											: 0xFB1F <= c : 0xFB2A <= c : c <= 0xFD3D ? c <= 0xFB41 ? c <= 0xFB3E
											? c <= 0xFB3C ? 0xFB38 <= c : 0xFB3E <= c
											: 0xFB40 <= c : c <= 0xFBB1
											? c <= 0xFB44 ? 0xFB43 <= c : 0xFB46 <= c
											: 0xFBD3 <= c : c <= 0xFDFB ? c <= 0xFDC7 ? c <= 0xFD8F
											? 0xFD50 <= c
											: 0xFD92 <= c : 0xFDF0 <= c : c <= 0xFE74 ? 0xFE70 <= c : 0xFE76 <= c
									: c <= 0x1003D
											? c <= 0xFFD7 ? c <= 0xFFBE ? c <= 0xFF5A ? c <= 0xFF3A
													? 0xFF21 <= c
													: 0xFF41 <= c : 0xFF66 <= c : c <= 0xFFCF ? c <= 0xFFC7
													? 0xFFC2 <= c
													: 0xFFCA <= c : 0xFFD2 <= c : c <= 0x10026 ? c <= 0x1000B
													? c <= 0xFFDC ? 0xFFDA <= c : 0x10000 <= c
													: 0x1000D <= c : c <= 0x1003A ? 0x10028 <= c : 0x1003C <= c
											: c <= 0x1034A ? c <= 0x100FA ? c <= 0x1005D ? c <= 0x1004D
													? 0x1003F <= c
													: 0x10050 <= c : 0x10080 <= c : c <= 0x1031E ? c <= 0x10174
													? 0x10140 <= c
													: 0x10300 <= c : 0x10330 <= c : c <= 0x103CF ? c <= 0x103C3
													? c <= 0x1039D ? 0x10380 <= c : 0x103A0 <= c
													: 0x103C8 <= c : c <= 0x103D5 ? 0x103D1 <= c : 0x10400 <= c
							: c <= 0x1D505
									? c <= 0x1236E ? c <= 0x1083F ? c <= 0x10835 ? c <= 0x10808 ? c <= 0x10805
											? 0x10800 <= c
											: 0x10808 <= c : 0x1080A <= c : c <= 0x1083C ? c <= 0x10838
											? 0x10837 <= c
											: 0x1083C <= c : 0x1083F <= c : c <= 0x10A13 ? c <= 0x10A00 ? c <= 0x10915
											? 0x10900 <= c
											: 0x10A00 <= c : 0x10A10 <= c : c <= 0x10A33 ? c <= 0x10A17
											? 0x10A15 <= c
											: 0x10A19 <= c : 0x12000 <= c : c <= 0x1D4A6 ? c <= 0x1D49C ? c <= 0x1D454
											? c <= 0x12462 ? 0x12400 <= c : 0x1D400 <= c
											: 0x1D456 <= c : c <= 0x1D4A2
											? c <= 0x1D49F ? 0x1D49E <= c : 0x1D4A2 <= c
											: 0x1D4A5 <= c : c <= 0x1D4BB ? c <= 0x1D4B9 ? c <= 0x1D4AC
											? 0x1D4A9 <= c
											: 0x1D4AE <= c : 0x1D4BB <= c : c <= 0x1D4C3 ? 0x1D4BD <= c : 0x1D4C5 <= c
									: c <= 0x1D6DA
											? c <= 0x1D544 ? c <= 0x1D51C ? c <= 0x1D514 ? c <= 0x1D50A
													? 0x1D507 <= c
													: 0x1D50D <= c : 0x1D516 <= c : c <= 0x1D53E ? c <= 0x1D539
													? 0x1D51E <= c
													: 0x1D53B <= c : 0x1D540 <= c : c <= 0x1D6A5 ? c <= 0x1D550
													? c <= 0x1D546 ? 0x1D546 <= c : 0x1D54A <= c
													: 0x1D552 <= c : c <= 0x1D6C0 ? 0x1D6A8 <= c : 0x1D6C2 <= c
											: c <= 0x1D788 ? c <= 0x1D734 ? c <= 0x1D714 ? c <= 0x1D6FA
													? 0x1D6DC <= c
													: 0x1D6FC <= c : 0x1D716 <= c : c <= 0x1D76E ? c <= 0x1D74E
													? 0x1D736 <= c
													: 0x1D750 <= c : 0x1D770 <= c : c <= 0x1D7CB ? c <= 0x1D7C2
													? c <= 0x1D7A8 ? 0x1D78A <= c : 0x1D7AA <= c
													: 0x1D7C4 <= c : c <= 0x2A6D6 ? 0x20000 <= c : 0x2F800 <= c
													&& c <= 0x2FA1D;
					// #/generated#
				}
				...
				function isIdentifierPart(c) {
					...
					return c <= 0x12B0 ? c <= 0xB90 ? c <= 0x990
							? c <= 0x5BF ? c <= 0x37D ? c <= 0xD6 ? c <= 0x7A ? c <= 0x5A ? c <= 0x39
									? 0x30 <= c
									: 0x41 <= c : c <= 0x5F ? 0x5F <= c : 0x61 <= c : c <= 0xB5 ? c <= 0xAA
									? 0xAA <= c
									: 0xB5 <= c : c <= 0xBA ? 0xBA <= c : 0xC0 <= c : c <= 0x2E4 ? c <= 0x2C1
									? c <= 0xF6 ? 0xD8 <= c : 0xF8 <= c
									: c <= 0x2D1 ? 0x2C6 <= c : 0x2E0 <= c : c <= 0x36F ? c <= 0x2EE
									? 0x2EE <= c
									: 0x300 <= c : 0x37A <= c : c <= 0x481 ? c <= 0x3A1 ? c <= 0x38A ? c <= 0x386
									? 0x386 <= c
									: 0x388 <= c : c <= 0x38C ? 0x38C <= c : 0x38E <= c : c <= 0x3F5 ? c <= 0x3CE
									? 0x3A3 <= c
									: 0x3D0 <= c : 0x3F7 <= c : c <= 0x559 ? c <= 0x513 ? c <= 0x486
									? 0x483 <= c
									: 0x48A <= c : c <= 0x556 ? 0x531 <= c : 0x559 <= c : c <= 0x5BD ? c <= 0x587
									? 0x561 <= c
									: 0x591 <= c : 0x5BF <= c : c <= 0x6FF ? c <= 0x63A ? c <= 0x5EA ? c <= 0x5C5
									? c <= 0x5C2 ? 0x5C1 <= c : 0x5C4 <= c
									: c <= 0x5C7 ? 0x5C7 <= c : 0x5D0 <= c : c <= 0x615 ? c <= 0x5F2
									? 0x5F0 <= c
									: 0x610 <= c : 0x621 <= c : c <= 0x6DC ? c <= 0x669 ? c <= 0x65E
									? 0x640 <= c
									: 0x660 <= c : c <= 0x6D3 ? 0x66E <= c : 0x6D5 <= c : c <= 0x6FC ? c <= 0x6E8
									? 0x6DF <= c
									: 0x6EA <= c : 0x6FF <= c : c <= 0x94D ? c <= 0x7F5 ? c <= 0x76D ? c <= 0x74A
									? 0x710 <= c
									: 0x74D <= c : c <= 0x7B1 ? 0x780 <= c : 0x7C0 <= c : c <= 0x939 ? c <= 0x7FA
									? 0x7FA <= c
									: 0x901 <= c : 0x93C <= c : c <= 0x97F ? c <= 0x963 ? c <= 0x954
									? 0x950 <= c
									: 0x958 <= c : c <= 0x96F ? 0x966 <= c : 0x97B <= c : c <= 0x98C ? c <= 0x983
									? 0x981 <= c
									: 0x985 <= c : 0x98F <= c
							: c <= 0xA91 ? c <= 0xA28 ? c <= 0x9D7 ? c <= 0x9B9 ? c <= 0x9B0 ? c <= 0x9A8
									? 0x993 <= c
									: 0x9AA <= c : c <= 0x9B2 ? 0x9B2 <= c : 0x9B6 <= c : c <= 0x9C8 ? c <= 0x9C4
									? 0x9BC <= c
									: 0x9C7 <= c : c <= 0x9CE ? 0x9CB <= c : 0x9D7 <= c : c <= 0xA03 ? c <= 0x9E3
									? c <= 0x9DD ? 0x9DC <= c : 0x9DF <= c
									: c <= 0x9F1 ? 0x9E6 <= c : 0xA01 <= c : c <= 0xA10 ? c <= 0xA0A
									? 0xA05 <= c
									: 0xA0F <= c : 0xA13 <= c : c <= 0xA48 ? c <= 0xA39 ? c <= 0xA33 ? c <= 0xA30
									? 0xA2A <= c
									: 0xA32 <= c : c <= 0xA36 ? 0xA35 <= c : 0xA38 <= c : c <= 0xA42 ? c <= 0xA3C
									? 0xA3C <= c
									: 0xA3E <= c : 0xA47 <= c : c <= 0xA74 ? c <= 0xA5C ? c <= 0xA4D
									? 0xA4B <= c
									: 0xA59 <= c : c <= 0xA5E ? 0xA5E <= c : 0xA66 <= c : c <= 0xA8D ? c <= 0xA83
									? 0xA81 <= c
									: 0xA85 <= c : 0xA8F <= c : c <= 0xB28 ? c <= 0xACD ? c <= 0xAB9 ? c <= 0xAB0
									? c <= 0xAA8 ? 0xA93 <= c : 0xAAA <= c
									: c <= 0xAB3 ? 0xAB2 <= c : 0xAB5 <= c : c <= 0xAC9 ? c <= 0xAC5
									? 0xABC <= c
									: 0xAC7 <= c : 0xACB <= c : c <= 0xB03 ? c <= 0xAE3 ? c <= 0xAD0
									? 0xAD0 <= c
									: 0xAE0 <= c : c <= 0xAEF ? 0xAE6 <= c : 0xB01 <= c : c <= 0xB10 ? c <= 0xB0C
									? 0xB05 <= c
									: 0xB0F <= c : 0xB13 <= c : c <= 0xB57 ? c <= 0xB43 ? c <= 0xB33 ? c <= 0xB30
									? 0xB2A <= c
									: 0xB32 <= c : c <= 0xB39 ? 0xB35 <= c : 0xB3C <= c : c <= 0xB4D ? c <= 0xB48
									? 0xB47 <= c
									: 0xB4B <= c : 0xB56 <= c : c <= 0xB71 ? c <= 0xB61 ? c <= 0xB5D
									? 0xB5C <= c
									: 0xB5F <= c : c <= 0xB6F ? 0xB66 <= c : 0xB71 <= c : c <= 0xB8A ? c <= 0xB83
									? 0xB82 <= c
									: 0xB85 <= c : 0xB8E <= c : c <= 0xDD6
							? c <= 0xCB3 ? c <= 0xC10 ? c <= 0xBC2 ? c <= 0xB9F ? c <= 0xB9A ? c <= 0xB95
									? 0xB92 <= c
									: 0xB99 <= c : c <= 0xB9C ? 0xB9C <= c : 0xB9E <= c : c <= 0xBAA ? c <= 0xBA4
									? 0xBA3 <= c
									: 0xBA8 <= c : c <= 0xBB9 ? 0xBAE <= c : 0xBBE <= c : c <= 0xBEF ? c <= 0xBCD
									? c <= 0xBC8 ? 0xBC6 <= c : 0xBCA <= c
									: c <= 0xBD7 ? 0xBD7 <= c : 0xBE6 <= c : c <= 0xC0C ? c <= 0xC03
									? 0xC01 <= c
									: 0xC05 <= c : 0xC0E <= c : c <= 0xC56 ? c <= 0xC44 ? c <= 0xC33 ? c <= 0xC28
									? 0xC12 <= c
									: 0xC2A <= c : c <= 0xC39 ? 0xC35 <= c : 0xC3E <= c : c <= 0xC4D ? c <= 0xC48
									? 0xC46 <= c
									: 0xC4A <= c : 0xC55 <= c : c <= 0xC8C ? c <= 0xC6F ? c <= 0xC61
									? 0xC60 <= c
									: 0xC66 <= c : c <= 0xC83 ? 0xC82 <= c : 0xC85 <= c : c <= 0xCA8 ? c <= 0xC90
									? 0xC8E <= c
									: 0xC92 <= c : 0xCAA <= c : c <= 0xD43 ? c <= 0xCE3 ? c <= 0xCCD ? c <= 0xCC4
									? c <= 0xCB9 ? 0xCB5 <= c : 0xCBC <= c
									: c <= 0xCC8 ? 0xCC6 <= c : 0xCCA <= c : c <= 0xCDE ? c <= 0xCD6
									? 0xCD5 <= c
									: 0xCDE <= c : 0xCE0 <= c : c <= 0xD10 ? c <= 0xD03 ? c <= 0xCEF
									? 0xCE6 <= c
									: 0xD02 <= c : c <= 0xD0C ? 0xD05 <= c : 0xD0E <= c : c <= 0xD39 ? c <= 0xD28
									? 0xD12 <= c
									: 0xD2A <= c : 0xD3E <= c : c <= 0xD96 ? c <= 0xD61 ? c <= 0xD4D ? c <= 0xD48
									? 0xD46 <= c
									: 0xD4A <= c : c <= 0xD57 ? 0xD57 <= c : 0xD60 <= c : c <= 0xD83 ? c <= 0xD6F
									? 0xD66 <= c
									: 0xD82 <= c : 0xD85 <= c : c <= 0xDC6 ? c <= 0xDBB ? c <= 0xDB1
									? 0xD9A <= c
									: 0xDB3 <= c : c <= 0xDBD ? 0xDBD <= c : 0xDC0 <= c : c <= 0xDD4 ? c <= 0xDCA
									? 0xDCA <= c
									: 0xDCF <= c : 0xDD6 <= c
							: c <= 0xF39 ? c <= 0xEA7 ? c <= 0xE88 ? c <= 0xE4E ? c <= 0xDF3 ? c <= 0xDDF
									? 0xDD8 <= c
									: 0xDF2 <= c : c <= 0xE3A ? 0xE01 <= c : 0xE40 <= c : c <= 0xE82 ? c <= 0xE59
									? 0xE50 <= c
									: 0xE81 <= c : c <= 0xE84 ? 0xE84 <= c : 0xE87 <= c : c <= 0xE9F ? c <= 0xE8D
									? c <= 0xE8A ? 0xE8A <= c : 0xE8D <= c
									: c <= 0xE97 ? 0xE94 <= c : 0xE99 <= c : c <= 0xEA5 ? c <= 0xEA3
									? 0xEA1 <= c
									: 0xEA5 <= c : 0xEA7 <= c : c <= 0xED9 ? c <= 0xEC4 ? c <= 0xEB9 ? c <= 0xEAB
									? 0xEAA <= c
									: 0xEAD <= c : c <= 0xEBD ? 0xEBB <= c : 0xEC0 <= c : c <= 0xECD ? c <= 0xEC6
									? 0xEC6 <= c
									: 0xEC8 <= c : 0xED0 <= c : c <= 0xF29 ? c <= 0xF00 ? c <= 0xEDD
									? 0xEDC <= c
									: 0xF00 <= c : c <= 0xF19 ? 0xF18 <= c : 0xF20 <= c : c <= 0xF37 ? c <= 0xF35
									? 0xF35 <= c
									: 0xF37 <= c : 0xF39 <= c : c <= 0x1059 ? c <= 0xFC6 ? c <= 0xF8B ? c <= 0xF6A
									? c <= 0xF47 ? 0xF3E <= c : 0xF49 <= c
									: c <= 0xF84 ? 0xF71 <= c : 0xF86 <= c : c <= 0xFBC ? c <= 0xF97
									? 0xF90 <= c
									: 0xF99 <= c : 0xFC6 <= c : c <= 0x1032 ? c <= 0x1027 ? c <= 0x1021
									? 0x1000 <= c
									: 0x1023 <= c : c <= 0x102A ? 0x1029 <= c : 0x102C <= c : c <= 0x1049 ? c <= 0x1039
									? 0x1036 <= c
									: 0x1040 <= c : 0x1050 <= c : c <= 0x1248 ? c <= 0x1159 ? c <= 0x10FA ? c <= 0x10C5
									? 0x10A0 <= c
									: 0x10D0 <= c : c <= 0x10FC ? 0x10FC <= c : 0x1100 <= c : c <= 0x11F9 ? c <= 0x11A2
									? 0x115F <= c
									: 0x11A8 <= c : 0x1200 <= c : c <= 0x125D ? c <= 0x1256 ? c <= 0x124D
									? 0x124A <= c
									: 0x1250 <= c : c <= 0x1258 ? 0x1258 <= c : 0x125A <= c : c <= 0x128D ? c <= 0x1288
									? 0x1260 <= c
									: 0x128A <= c : 0x1290 <= c : c <= 0x30FF ? c <= 0x1FB4 ? c <= 0x180D ? c <= 0x16EA
							? c <= 0x135A ? c <= 0x12C5 ? c <= 0x12BE
									? c <= 0x12B5 ? 0x12B2 <= c : 0x12B8 <= c
									: c <= 0x12C0 ? 0x12C0 <= c : 0x12C2 <= c : c <= 0x1310 ? c <= 0x12D6
									? 0x12C8 <= c
									: 0x12D8 <= c : c <= 0x1315 ? 0x1312 <= c : 0x1318 <= c : c <= 0x166C ? c <= 0x138F
									? c <= 0x135F ? 0x135F <= c : 0x1380 <= c
									: c <= 0x13F4 ? 0x13A0 <= c : 0x1401 <= c : c <= 0x169A ? c <= 0x1676
									? 0x166F <= c
									: 0x1681 <= c : 0x16A0 <= c
							: c <= 0x1770 ? c <= 0x1734 ? c <= 0x170C
									? c <= 0x16F0 ? 0x16EE <= c : 0x1700 <= c
									: c <= 0x1714 ? 0x170E <= c : 0x1720 <= c : c <= 0x176C ? c <= 0x1753
									? 0x1740 <= c
									: 0x1760 <= c : 0x176E <= c : c <= 0x17D7 ? c <= 0x17B3 ? c <= 0x1773
									? 0x1772 <= c
									: 0x1780 <= c : c <= 0x17D3 ? 0x17B6 <= c : 0x17D7 <= c : c <= 0x17E9 ? c <= 0x17DD
									? 0x17DC <= c
									: 0x17E0 <= c : 0x180B <= c : c <= 0x1B59 ? c <= 0x196D ? c <= 0x191C ? c <= 0x1877
							? c <= 0x1819 ? 0x1810 <= c : 0x1820 <= c
							: c <= 0x18A9 ? 0x1880 <= c : 0x1900 <= c : c <= 0x193B ? c <= 0x192B
							? 0x1920 <= c
							: 0x1930 <= c : 0x1946 <= c : c <= 0x19D9 ? c <= 0x19A9 ? c <= 0x1974
							? 0x1970 <= c
							: 0x1980 <= c : c <= 0x19C9 ? 0x19B0 <= c : 0x19D0 <= c : c <= 0x1B4B ? c <= 0x1A1B
							? 0x1A00 <= c
							: 0x1B00 <= c : 0x1B50 <= c : c <= 0x1F45 ? c <= 0x1EF9 ? c <= 0x1DCA ? c <= 0x1B73
							? 0x1B6B <= c
							: 0x1D00 <= c : c <= 0x1E9B ? 0x1DFE <= c : 0x1EA0 <= c : c <= 0x1F1D ? c <= 0x1F15
							? 0x1F00 <= c
							: 0x1F18 <= c : 0x1F20 <= c : c <= 0x1F5B ? c <= 0x1F57 ? c <= 0x1F4D
							? 0x1F48 <= c
							: 0x1F50 <= c : c <= 0x1F59 ? 0x1F59 <= c : 0x1F5B <= c : c <= 0x1F7D ? c <= 0x1F5D
							? 0x1F5D <= c
							: 0x1F5F <= c : 0x1F80 <= c : c <= 0x2149 ? c <= 0x20DC ? c <= 0x1FF4 ? c <= 0x1FCC
							? c <= 0x1FBE ? c <= 0x1FBC ? 0x1FB6 <= c : 0x1FBE <= c : c <= 0x1FC4
									? 0x1FC2 <= c
									: 0x1FC6 <= c
							: c <= 0x1FDB ? c <= 0x1FD3 ? 0x1FD0 <= c : 0x1FD6 <= c : c <= 0x1FEC
									? 0x1FE0 <= c
									: 0x1FF2 <= c : c <= 0x2071 ? c <= 0x2040
							? c <= 0x1FFC ? 0x1FF6 <= c : 0x203F <= c
							: c <= 0x2054 ? 0x2054 <= c : 0x2071 <= c : c <= 0x2094 ? c <= 0x207F
							? 0x207F <= c
							: 0x2090 <= c : 0x20D0 <= c : c <= 0x211D ? c <= 0x2107 ? c <= 0x20EF ? c <= 0x20E1
							? 0x20E1 <= c
							: 0x20E5 <= c : c <= 0x2102 ? 0x2102 <= c : 0x2107 <= c : c <= 0x2115 ? c <= 0x2113
							? 0x210A <= c
							: 0x2115 <= c : 0x2119 <= c : c <= 0x212D ? c <= 0x2126 ? c <= 0x2124
							? 0x2124 <= c
							: 0x2126 <= c : c <= 0x2128 ? 0x2128 <= c : 0x212A <= c : c <= 0x213F ? c <= 0x2139
							? 0x212F <= c
							: 0x213C <= c : 0x2145 <= c : c <= 0x2DB6 ? c <= 0x2CE4 ? c <= 0x2C5E ? c <= 0x2184
							? c <= 0x214E ? 0x214E <= c : 0x2160 <= c
							: c <= 0x2C2E ? 0x2C00 <= c : 0x2C30 <= c : c <= 0x2C77 ? c <= 0x2C6C
							? 0x2C60 <= c
							: 0x2C74 <= c : 0x2C80 <= c : c <= 0x2D96 ? c <= 0x2D65 ? c <= 0x2D25
							? 0x2D00 <= c
							: 0x2D30 <= c : c <= 0x2D6F ? 0x2D6F <= c : 0x2D80 <= c : c <= 0x2DAE ? c <= 0x2DA6
							? 0x2DA0 <= c
							: 0x2DA8 <= c : 0x2DB0 <= c : c <= 0x302F ? c <= 0x2DD6 ? c <= 0x2DC6 ? c <= 0x2DBE
							? 0x2DB8 <= c
							: 0x2DC0 <= c : c <= 0x2DCE ? 0x2DC8 <= c : 0x2DD0 <= c : c <= 0x3007 ? c <= 0x2DDE
							? 0x2DD8 <= c
							: 0x3005 <= c : 0x3021 <= c : c <= 0x309A ? c <= 0x303C ? c <= 0x3035
							? 0x3031 <= c
							: 0x3038 <= c : c <= 0x3096 ? 0x3041 <= c : 0x3099 <= c : c <= 0x30FA ? c <= 0x309F
							? 0x309D <= c
							: 0x30A1 <= c : 0x30FC <= c : c <= 0x1049D ? c <= 0xFE23 ? c <= 0xFB06
							? c <= 0xA71A ? c <= 0x31FF ? c <= 0x318E
									? c <= 0x312C ? 0x3105 <= c : 0x3131 <= c
									: c <= 0x31B7 ? 0x31A0 <= c : 0x31F0 <= c : c <= 0x9FBB ? c <= 0x4DB5
									? 0x3400 <= c
									: 0x4E00 <= c : c <= 0xA48C ? 0xA000 <= c : 0xA717 <= c : c <= 0xFA2D ? c <= 0xA873
									? c <= 0xA827 ? 0xA800 <= c : 0xA840 <= c
									: c <= 0xD7A3 ? 0xAC00 <= c : 0xF900 <= c : c <= 0xFAD9 ? c <= 0xFA6A
									? 0xFA30 <= c
									: 0xFA70 <= c : 0xFB00 <= c
							: c <= 0xFB44 ? c <= 0xFB3C ? c <= 0xFB28
									? c <= 0xFB17 ? 0xFB13 <= c : 0xFB1D <= c
									: c <= 0xFB36 ? 0xFB2A <= c : 0xFB38 <= c : c <= 0xFB41 ? c <= 0xFB3E
									? 0xFB3E <= c
									: 0xFB40 <= c : 0xFB43 <= c : c <= 0xFDC7 ? c <= 0xFD3D ? c <= 0xFBB1
									? 0xFB46 <= c
									: 0xFBD3 <= c : c <= 0xFD8F ? 0xFD50 <= c : 0xFD92 <= c : c <= 0xFE0F ? c <= 0xFDFB
									? 0xFDF0 <= c
									: 0xFE00 <= c : 0xFE20 <= c : c <= 0x1000B ? c <= 0xFF3F ? c <= 0xFEFC
							? c <= 0xFE4F ? c <= 0xFE34 ? 0xFE33 <= c : 0xFE4D <= c : c <= 0xFE74
									? 0xFE70 <= c
									: 0xFE76 <= c
							: c <= 0xFF3A ? c <= 0xFF19 ? 0xFF10 <= c : 0xFF21 <= c : 0xFF3F <= c : c <= 0xFFCF
							? c <= 0xFFBE ? c <= 0xFF5A ? 0xFF41 <= c : 0xFF66 <= c : c <= 0xFFC7
									? 0xFFC2 <= c
									: 0xFFCA <= c
							: c <= 0xFFDC ? c <= 0xFFD7 ? 0xFFD2 <= c : 0xFFDA <= c : 0x10000 <= c : c <= 0x10174
							? c <= 0x1004D ? c <= 0x1003A ? c <= 0x10026 ? 0x1000D <= c : 0x10028 <= c : c <= 0x1003D
									? 0x1003C <= c
									: 0x1003F <= c : c <= 0x100FA
									? c <= 0x1005D ? 0x10050 <= c : 0x10080 <= c
									: 0x10140 <= c
							: c <= 0x103C3 ? c <= 0x1034A ? c <= 0x1031E ? 0x10300 <= c : 0x10330 <= c : c <= 0x1039D
									? 0x10380 <= c
									: 0x103A0 <= c : c <= 0x103D5
									? c <= 0x103CF ? 0x103C8 <= c : 0x103D1 <= c
									: 0x10400 <= c : c <= 0x1D4AC ? c <= 0x10A3F ? c <= 0x10915 ? c <= 0x10835
							? c <= 0x10805 ? c <= 0x104A9 ? 0x104A0 <= c : 0x10800 <= c : c <= 0x10808
									? 0x10808 <= c
									: 0x1080A <= c
							: c <= 0x1083C ? c <= 0x10838 ? 0x10837 <= c : 0x1083C <= c : c <= 0x1083F
									? 0x1083F <= c
									: 0x10900 <= c : c <= 0x10A17 ? c <= 0x10A06 ? c <= 0x10A03
							? 0x10A00 <= c
							: 0x10A05 <= c : c <= 0x10A13 ? 0x10A0C <= c : 0x10A15 <= c : c <= 0x10A3A ? c <= 0x10A33
							? 0x10A19 <= c
							: 0x10A38 <= c : 0x10A3F <= c : c <= 0x1D1AD ? c <= 0x1D172 ? c <= 0x12462 ? c <= 0x1236E
							? 0x12000 <= c
							: 0x12400 <= c : c <= 0x1D169 ? 0x1D165 <= c : 0x1D16D <= c : c <= 0x1D18B ? c <= 0x1D182
							? 0x1D17B <= c
							: 0x1D185 <= c : 0x1D1AA <= c : c <= 0x1D49F ? c <= 0x1D454 ? c <= 0x1D244
							? 0x1D242 <= c
							: 0x1D400 <= c : c <= 0x1D49C ? 0x1D456 <= c : 0x1D49E <= c : c <= 0x1D4A6 ? c <= 0x1D4A2
							? 0x1D4A2 <= c
							: 0x1D4A5 <= c : 0x1D4A9 <= c : c <= 0x1D6C0 ? c <= 0x1D51C ? c <= 0x1D505 ? c <= 0x1D4BB
							? c <= 0x1D4B9 ? 0x1D4AE <= c : 0x1D4BB <= c
							: c <= 0x1D4C3 ? 0x1D4BD <= c : 0x1D4C5 <= c : c <= 0x1D514 ? c <= 0x1D50A
							? 0x1D507 <= c
							: 0x1D50D <= c : 0x1D516 <= c : c <= 0x1D546 ? c <= 0x1D53E ? c <= 0x1D539
							? 0x1D51E <= c
							: 0x1D53B <= c : c <= 0x1D544 ? 0x1D540 <= c : 0x1D546 <= c : c <= 0x1D6A5 ? c <= 0x1D550
							? 0x1D54A <= c
							: 0x1D552 <= c : 0x1D6A8 <= c : c <= 0x1D788 ? c <= 0x1D734 ? c <= 0x1D6FA ? c <= 0x1D6DA
							? 0x1D6C2 <= c
							: 0x1D6DC <= c : c <= 0x1D714 ? 0x1D6FC <= c : 0x1D716 <= c : c <= 0x1D76E ? c <= 0x1D74E
							? 0x1D736 <= c
							: 0x1D750 <= c : 0x1D770 <= c : c <= 0x1D7FF ? c <= 0x1D7C2 ? c <= 0x1D7A8
							? 0x1D78A <= c
							: 0x1D7AA <= c : c <= 0x1D7CB ? 0x1D7C4 <= c : 0x1D7CE <= c : c <= 0x2FA1D ? c <= 0x2A6D6
							? 0x20000 <= c
							: 0x2F800 <= c : 0xE0100 <= c && c <= 0xE01EF;
					// #/generated#
				}
...
(function() {
	...
	if (!this.Data.Functional || (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		this.Data.Functional = new Object();
	if (this.Concurrent.Thread.Compiler.IdentifierSet === undefined)
		this.Concurrent.Thread.Compiler.IdentifierSet = undefined;
	with (function() {
		with (Data.Error) {
			with (Data.Iterator) {
				with (Data.Functional) {
					with (Concurrent.Thread.Compiler) {
						...
						return function() {
							 ...
							 * "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License
							 * for the specific language governing rights and limitations under the License. The
							 * Original Code is Concurrent.Thread code. The Initial Developer of the Original Code is
							 * Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2006-2007 the
							 * Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of
							 * this file may be used under the terms of either the GNU General Public License Version 2
							 * or later (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the
							 * "LGPL"), in which case the provisions of the GPL or the LGPL are applicable instead of
							...
							proto.contains = function( /* variable arguments */) {
								for (var i = 0; i < arguments.length; i++) {
									...
									if (!(id instanceof Identifier))
										throw new TypeError("arguments[" + i + "] is not of type Identifier");
									// Because "hasOwnProperty" itself can be used as identifier,
									// we need to avoid "this._set.hasOwnProperty".
									if (!hasOwnProperty.call(this._set, id.valueOf()))
										return false;
								}
								return true;
							};
							...
							proto.remove = function( /* variable arguments */) {
								...
								for (var i = 0; i < arguments.length; i++) {
									var id = arguments[i];
									if (!(id instanceof Identifier))
										throw new TypeError("argument is not of type Identifier");
									var p = id.valueOf();
							...
							proto.toArray = function() {
								...
								for (var i in this._set) {
									if (hasOwnProperty.call(this._set, i))
										arr.push(this._set[i]);
								}
								return arr;
							};
							...
							proto.isTail = function() {
								if (this._state_no !== this._parent._state_no)
									throw new IllegalStateError("parent IdentifierSet object's state has been changed");
							...
							proto.next = function() {
								if (this._state_no !== this._parent._state_no)
									throw new IllegalStateError("parent IdentifierSet object's state has been changed");
								if (this.isTail())
									throw new NoSuchElementError("no more element after the tail");
...
(function() {
	...
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (this.Concurrent.Thread.Compiler.ErrorReporter === undefined)
		this.Concurrent.Thread.Compiler.ErrorReporter = undefined;
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				...
				/*******************************************************************************************************
				 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0 The contents of this file are subject to the
				 * Mozilla Public License Version 1.1 (the "License"); you may not use this file except in compliance
				 ...
				 * under the License. The Original Code is Rhino code, released May 6, 1999. The Initial Developer of
				 * the Original Code is Netscape Communications Corporation. Portions created by the Initial Developer
				 * are Copyright (C) 1997-1999 the Initial Developer. All Rights Reserved. Contributor(s): Norris Boyd
				 * Daisuke Maki Alternatively, the contents of this file may be used under the terms of the GNU General
				 * Public License Version 2 or later (the "GPL"), in which case the provisions of the GPL are applicable
				 * instead of those above. If you wish to allow use of your version of this file only under the terms of
				 * the GPL and not to allow others to use your version of this file under the MPL, indicate your
				 * decision by deleting the provisions above and replacing them with the notice and other provisions
				 * required by the GPL. If you do not delete the provisions above, a recipient may use your version of
				 * this file under either the MPL or the GPL. ***** END LICENSE BLOCK *****
				 */
				...
				/**
				 * Report an error. The implementing class is free to throw an exception if it desires. If execution has
				 * not yet begun, the JavaScript engine is free to find additional errors rather than terminating the
				 * translation. It will not execute a script that had errors, however.
				 * 
				 * @param message
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (this.Concurrent.Thread.Mutex === undefined)
		this.Concurrent.Thread.Mutex = undefined;
	with (function() {
		with (Data) {
			with (Data.Error) {
				with (Concurrent) {
					with (Concurrent.Thread) {
						...
						return function() {
							 ...
							 * for the specific language governing rights and limitations under the License. The
							 * Original Code is Concurrent.Thread code. The Initial Developer of the Original Code is
							 * Daisuke Maki. Portions created by the Initial Developer are Copyright (C) 2008 the
							 * Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the contents of
							 * this file may be used under the terms of either the GNU General Public License Version 2
							 * or later (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later (the
							 * "LGPL"), in which case the provisions of the GPL or the LGPL are applicable instead of
...
(function() {
	...
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (!this.Concurrent.Thread.Compiler.Kit
			|| (typeof this.Concurrent.Thread.Compiler.Kit != 'object' && typeof this.Concurrent.Thread.Compiler.Kit != 'function'))
		this.Concurrent.Thread.Compiler.Kit = new Object();
	if (this.Concurrent.Thread.Compiler.Kit.printTrees === undefined)
		this.Concurrent.Thread.Compiler.Kit.printTrees = undefined;
	if (this.Concurrent.Thread.Compiler.Kit.codeBug === undefined)
		this.Concurrent.Thread.Compiler.Kit.codeBug = undefined;
	with (function() {
		with (Concurrent.Thread.Compiler.Kit) {
			...
			return function() {
				 ...
				 * under the License. The Original Code is Rhino code, released May 6, 1999. The Initial Developer of
				 * the Original Code is Netscape Communications Corporation. Portions created by the Initial Developer
				 * are Copyright (C) 1997-1999 the Initial Developer. All Rights Reserved. Contributor(s): Igor Bukanov,
				 * igor@fastmail.fm Daisuke Maki Alternatively, the contents of this file may be used under the terms of
				 * the GNU General Public License Version 2 or later (the "GPL"), in which case the provisions of the
				 * GPL are applicable instead of those above. If you wish to allow use of your version of this file only
				 * under the terms of the GPL and not to allow others to use your version of this file under the MPL,
				 * indicate your decision by deleting the provisions above and replacing them with the notice and other
				 * provisions required by the GPL. If you do not delete the provisions above, a recipient may use your
				 * version of this file under either the MPL or the GPL. ***** END LICENSE BLOCK *****
				 */
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (!this.Concurrent.Thread.Continuation
			|| (typeof this.Concurrent.Thread.Continuation != 'object' && typeof this.Concurrent.Thread.Continuation != 'function'))
		this.Concurrent.Thread.Continuation = new Object();
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Error || (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
		this.Data.Error = new Object();
	if (this.Concurrent.Thread.Continuation.callcc === undefined)
		this.Concurrent.Thread.Continuation.callcc = undefined;
	if (this.Concurrent.Thread.Continuation.getCC === undefined)
		this.Concurrent.Thread.Continuation.getCC = undefined;
	if (this.Concurrent.Thread.Continuation.currentContinuation === undefined)
		this.Concurrent.Thread.Continuation.currentContinuation = undefined;
	if (this.Concurrent.Thread.Continuation.ContinuationCalledException === undefined)
		this.Concurrent.Thread.Continuation.ContinuationCalledException = undefined;
	with (function() {
		with (Data.Error) {
			with (Concurrent.Thread.Continuation) {
				...
				return function() {
					 ...
					 * and limitations under the License. The Original Code is Concurrent.Thread code. The Initial
					 * Developer of the Original Code is Daisuke Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2008 the Initial Developer. All Rights Reserved. Contributor(s): Alternatively, the
					 * contents of this file may be used under the terms of either the GNU General Public License
					 * Version 2 or later (the "GPL"), or the GNU Lesser General Public License Version 2.1 or later
					 * (the "LGPL"), in which case the provisions of the GPL or the LGPL are applicable instead of those
					 * above. If you wish to allow use of your version of this file only under the terms of either the
					 * GPL or the LGPL, and not to allow others to use your version of this file under the terms of the
					 * MPL, indicate your decision by deleting the provisions above and replace them with the notice and
					 * other provisions required by the GPL or the LGPL. If you do not delete the provisions above, a
					 * recipient may use your version of this file under the terms of any one of the MPL, the GPL or the
					...
					callcc.$Concurrent_Thread_compiled = function($this, $args, $cont) {
						...
						var f = $args[0];
						return f && typeof f.$Concurrent_Thread_compiled === "function" ? f
								.$Concurrent_Thread_compiled(null, [continuation], $cont) : {
							continuation : $cont,
							ret_val : f(continuation),
							timeout : void 0
						};
					};
					...
					var ContinuationCalledException = Exception.extend(function($super, args) {
					...
					return {
						ContinuationCalledException : ContinuationCalledException,
						callcc : callcc,
						getCC : getCC,
...
(function() {
	...
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (this.Concurrent.Thread.Compiler.Token === undefined)
		this.Concurrent.Thread.Compiler.Token = undefined;
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				 ...
				 * under the License. The Original Code is Rhino code, released May 6, 1999. The Initial Developer of
				 * the Original Code is Netscape Communications Corporation. Portions created by the Initial Developer
				 * are Copyright (C) 1997-1999 the Initial Developer. All Rights Reserved. Contributor(s): Roger
				 * Lawrence Mike McCabe Igor Bukanov Milen Nankov Daisuke Maki Alternatively, the contents of this file
				 * may be used under the terms of the GNU General Public License Version 2 or later (the "GPL"), in
				 * which case the provisions of the GPL are applicable instead of those above. If you wish to allow use
				 * of your version of this file only under the terms of the GPL and not to allow others to use your
				 * version of this file under the MPL, indicate your decision by deleting the provisions above and
				 * replacing them with the notice and other provisions required by the GPL. If you do not delete the
				 * provisions above, a recipient may use your version of this file under either the MPL or the GPL.
				 * ***** END LICENSE BLOCK *****
				 */
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.Expression === undefined)
		this.Concurrent.Thread.Compiler.Expression = undefined;
	if (this.Concurrent.Thread.Compiler.UnaryExpression === undefined)
		this.Concurrent.Thread.Compiler.UnaryExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BinaryExpression === undefined)
		this.Concurrent.Thread.Compiler.BinaryExpression = undefined;
	if (this.Concurrent.Thread.Compiler.ThisExpression === undefined)
		this.Concurrent.Thread.Compiler.ThisExpression = undefined;
	if (this.Concurrent.Thread.Compiler.Identifier === undefined)
		this.Concurrent.Thread.Compiler.Identifier = undefined;
	if (this.Concurrent.Thread.Compiler.Literal === undefined)
		this.Concurrent.Thread.Compiler.Literal = undefined;
	if (this.Concurrent.Thread.Compiler.NumberLiteral === undefined)
		this.Concurrent.Thread.Compiler.NumberLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.StringLiteral === undefined)
		this.Concurrent.Thread.Compiler.StringLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.RegExpLiteral === undefined)
		this.Concurrent.Thread.Compiler.RegExpLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.NullLiteral === undefined)
		this.Concurrent.Thread.Compiler.NullLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.BooleanLiteral === undefined)
		this.Concurrent.Thread.Compiler.BooleanLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.TrueLiteral === undefined)
		this.Concurrent.Thread.Compiler.TrueLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.FalseLiteral === undefined)
		this.Concurrent.Thread.Compiler.FalseLiteral = undefined;
	if (this.Concurrent.Thread.Compiler.ArrayInitializer === undefined)
		this.Concurrent.Thread.Compiler.ArrayInitializer = undefined;
	if (this.Concurrent.Thread.Compiler.Elision === undefined)
		this.Concurrent.Thread.Compiler.Elision = undefined;
	if (this.Concurrent.Thread.Compiler.ObjectInitializer === undefined)
		this.Concurrent.Thread.Compiler.ObjectInitializer = undefined;
	if (this.Concurrent.Thread.Compiler.FunctionExpression === undefined)
		this.Concurrent.Thread.Compiler.FunctionExpression = undefined;
	if (this.Concurrent.Thread.Compiler.DotAccessor === undefined)
		this.Concurrent.Thread.Compiler.DotAccessor = undefined;
	if (this.Concurrent.Thread.Compiler.BracketAccessor === undefined)
		this.Concurrent.Thread.Compiler.BracketAccessor = undefined;
	if (this.Concurrent.Thread.Compiler.NewExpression === undefined)
		this.Concurrent.Thread.Compiler.NewExpression = undefined;
	if (this.Concurrent.Thread.Compiler.CallExpression === undefined)
		this.Concurrent.Thread.Compiler.CallExpression = undefined;
	if (this.Concurrent.Thread.Compiler.PostIncExpression === undefined)
		this.Concurrent.Thread.Compiler.PostIncExpression = undefined;
	if (this.Concurrent.Thread.Compiler.PostDecExpression === undefined)
		this.Concurrent.Thread.Compiler.PostDecExpression = undefined;
	if (this.Concurrent.Thread.Compiler.PreIncExpression === undefined)
		this.Concurrent.Thread.Compiler.PreIncExpression = undefined;
	if (this.Concurrent.Thread.Compiler.PreDecExpression === undefined)
		this.Concurrent.Thread.Compiler.PreDecExpression = undefined;
	if (this.Concurrent.Thread.Compiler.DeleteExpression === undefined)
		this.Concurrent.Thread.Compiler.DeleteExpression = undefined;
	if (this.Concurrent.Thread.Compiler.VoidExpression === undefined)
		this.Concurrent.Thread.Compiler.VoidExpression = undefined;
	if (this.Concurrent.Thread.Compiler.TypeofExpression === undefined)
		this.Concurrent.Thread.Compiler.TypeofExpression = undefined;
	if (this.Concurrent.Thread.Compiler.PosExpression === undefined)
		this.Concurrent.Thread.Compiler.PosExpression = undefined;
	if (this.Concurrent.Thread.Compiler.NegExpression === undefined)
		this.Concurrent.Thread.Compiler.NegExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitNotExpression === undefined)
		this.Concurrent.Thread.Compiler.BitNotExpression = undefined;
	if (this.Concurrent.Thread.Compiler.NotExpression === undefined)
		this.Concurrent.Thread.Compiler.NotExpression = undefined;
	if (this.Concurrent.Thread.Compiler.MulExpression === undefined)
		this.Concurrent.Thread.Compiler.MulExpression = undefined;
	if (this.Concurrent.Thread.Compiler.DivExpression === undefined)
		this.Concurrent.Thread.Compiler.DivExpression = undefined;
	if (this.Concurrent.Thread.Compiler.ModExpression === undefined)
		this.Concurrent.Thread.Compiler.ModExpression = undefined;
	if (this.Concurrent.Thread.Compiler.AddExpression === undefined)
		this.Concurrent.Thread.Compiler.AddExpression = undefined;
	if (this.Concurrent.Thread.Compiler.SubExpression === undefined)
		this.Concurrent.Thread.Compiler.SubExpression = undefined;
	if (this.Concurrent.Thread.Compiler.LShiftExpression === undefined)
		this.Concurrent.Thread.Compiler.LShiftExpression = undefined;
	if (this.Concurrent.Thread.Compiler.RShiftExpression === undefined)
		this.Concurrent.Thread.Compiler.RShiftExpression = undefined;
	if (this.Concurrent.Thread.Compiler.URShiftExpression === undefined)
		this.Concurrent.Thread.Compiler.URShiftExpression = undefined;
	if (this.Concurrent.Thread.Compiler.LessThanExpression === undefined)
		this.Concurrent.Thread.Compiler.LessThanExpression = undefined;
	if (this.Concurrent.Thread.Compiler.GreaterThanExpression === undefined)
		this.Concurrent.Thread.Compiler.GreaterThanExpression = undefined;
	if (this.Concurrent.Thread.Compiler.LessEqualExpression === undefined)
		this.Concurrent.Thread.Compiler.LessEqualExpression = undefined;
	if (this.Concurrent.Thread.Compiler.GreaterEqualExpression === undefined)
		this.Concurrent.Thread.Compiler.GreaterEqualExpression = undefined;
	if (this.Concurrent.Thread.Compiler.InstanceofExpression === undefined)
		this.Concurrent.Thread.Compiler.InstanceofExpression = undefined;
	if (this.Concurrent.Thread.Compiler.InExpression === undefined)
		this.Concurrent.Thread.Compiler.InExpression = undefined;
	if (this.Concurrent.Thread.Compiler.EqualExpression === undefined)
		this.Concurrent.Thread.Compiler.EqualExpression = undefined;
	if (this.Concurrent.Thread.Compiler.NotEqualExpression === undefined)
		this.Concurrent.Thread.Compiler.NotEqualExpression = undefined;
	if (this.Concurrent.Thread.Compiler.StrictEqualExpression === undefined)
		this.Concurrent.Thread.Compiler.StrictEqualExpression = undefined;
	if (this.Concurrent.Thread.Compiler.StrictNotEqualExpression === undefined)
		this.Concurrent.Thread.Compiler.StrictNotEqualExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitAndExpression === undefined)
		this.Concurrent.Thread.Compiler.BitAndExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitXorExpression === undefined)
		this.Concurrent.Thread.Compiler.BitXorExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitOrExpression === undefined)
		this.Concurrent.Thread.Compiler.BitOrExpression = undefined;
	if (this.Concurrent.Thread.Compiler.AndExpression === undefined)
		this.Concurrent.Thread.Compiler.AndExpression = undefined;
	if (this.Concurrent.Thread.Compiler.OrExpression === undefined)
		this.Concurrent.Thread.Compiler.OrExpression = undefined;
	if (this.Concurrent.Thread.Compiler.ConditionalExpression === undefined)
		this.Concurrent.Thread.Compiler.ConditionalExpression = undefined;
	if (this.Concurrent.Thread.Compiler.AssignExpression === undefined)
		this.Concurrent.Thread.Compiler.AssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.SimpleAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.SimpleAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.MulAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.MulAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.DivAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.DivAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.ModAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.ModAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.AddAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.AddAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.SubAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.SubAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.LShiftAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.LShiftAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.RShiftAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.RShiftAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.URShiftAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.URShiftAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitAndAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.BitAndAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitXorAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.BitXorAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.BitOrAssignExpression === undefined)
		this.Concurrent.Thread.Compiler.BitOrAssignExpression = undefined;
	if (this.Concurrent.Thread.Compiler.CommaExpression === undefined)
		this.Concurrent.Thread.Compiler.CommaExpression = undefined;
	with (function() {
		with (Data.Cons) {
			with (Concurrent.Thread.Compiler) {
				...
				return function() {
					...
					proto.containsFunctionCall = function() {
						for (var i = 0; i < this.elems.length; i++) {
							if (this.elems[i].containsFunctionCall())
								return true;
						}
						return false;
					};
					...
					proto.containsFunctionCall = function() {
						for (var i = 0; i < this.pairs.length; i++) {
							if (this.pairs[i].exp.containsFunctionCall())
								return true;
						}
						return false;
					};
					...
					proto.hasSideEffect = function() {
						for (var i = 0; i < this.pairs.length; i++) {
							if (this.pairs[i].exp.hasSideEffect())
								return true;
						}
						return false;
					};
					...
					proto.containsFunctionCall = function() {
						return this.cond.containsFunctionCall() || this.texp.containsFunctionCall()
								|| this.fexp.containsFunctionCall();
					};

					proto.hasSideEffect = function() {
						return this.cond.hasSideEffect() || this.texp.hasSideEffect() || this.fexp.hasSideEffect();
					};
					...
					return {
						StrictEqualExpression : StrictEqualExpression,
						BooleanLiteral : BooleanLiteral,
						OrExpression : OrExpression,
						NotExpression : NotExpression,
						ThisExpression : ThisExpression,
						BitAndAssignExpression : BitAndAssignExpression,
						...
						Elision : Elision,
						PostIncExpression : PostIncExpression,
						InstanceofExpression : InstanceofExpression,
						NullLiteral : NullLiteral,
						BitXorAssignExpression : BitXorAssignExpression,
						URShiftExpression : URShiftExpression,
						ConditionalExpression : ConditionalExpression,
						Identifier : Identifier,
						UnaryExpression : UnaryExpression,
						BitOrAssignExpression : BitOrAssignExpression,
						...
						LShiftAssignExpression : LShiftAssignExpression,
						SubAssignExpression : SubAssignExpression,
						LShiftExpression : LShiftExpression,
						ModAssignExpression : ModAssignExpression,
						URShiftAssignExpression : URShiftAssignExpression,
						...
						StrictNotEqualExpression : StrictNotEqualExpression,
						RShiftExpression : RShiftExpression,
						InExpression : InExpression,
						BitOrExpression : BitOrExpression,
						AndExpression : AndExpression,
						PostDecExpression : PostDecExpression,
						ObjectInitializer : ObjectInitializer,
						RShiftAssignExpression : RShiftAssignExpression,
						Expression : Expression,
						DotAccessor : DotAccessor,
						Literal : Literal,
						SimpleAssignExpression : SimpleAssignExpression,
						BitXorExpression : BitXorExpression,
						AddExpression : AddExpression,
						GreaterThanExpression : GreaterThanExpression,
						NotEqualExpression : NotEqualExpression,
						PreIncExpression : PreIncExpression
					};
				}();
			}
		}
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.Statement === undefined)
		this.Concurrent.Thread.Compiler.Statement = undefined;
	if (this.Concurrent.Thread.Compiler.EmptyStatement === undefined)
		this.Concurrent.Thread.Compiler.EmptyStatement = undefined;
	if (this.Concurrent.Thread.Compiler.Block === undefined)
		this.Concurrent.Thread.Compiler.Block = undefined;
	if (this.Concurrent.Thread.Compiler.ExpStatement === undefined)
		this.Concurrent.Thread.Compiler.ExpStatement = undefined;
	if (this.Concurrent.Thread.Compiler.VarStatement === undefined)
		this.Concurrent.Thread.Compiler.VarStatement = undefined;
	if (this.Concurrent.Thread.Compiler.IfStatement === undefined)
		this.Concurrent.Thread.Compiler.IfStatement = undefined;
	if (this.Concurrent.Thread.Compiler.IfElseStatement === undefined)
		this.Concurrent.Thread.Compiler.IfElseStatement = undefined;
	if (this.Concurrent.Thread.Compiler.DoWhileStatement === undefined)
		this.Concurrent.Thread.Compiler.DoWhileStatement = undefined;
	if (this.Concurrent.Thread.Compiler.WhileStatement === undefined)
		this.Concurrent.Thread.Compiler.WhileStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ForStatement === undefined)
		this.Concurrent.Thread.Compiler.ForStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ForVarStatement === undefined)
		this.Concurrent.Thread.Compiler.ForVarStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ForInStatement === undefined)
		this.Concurrent.Thread.Compiler.ForInStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ForInVarStatement === undefined)
		this.Concurrent.Thread.Compiler.ForInVarStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ForEachStatement === undefined)
		this.Concurrent.Thread.Compiler.ForEachStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ForEachVarStatement === undefined)
		this.Concurrent.Thread.Compiler.ForEachVarStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ContinueStatement === undefined)
		this.Concurrent.Thread.Compiler.ContinueStatement = undefined;
	if (this.Concurrent.Thread.Compiler.BreakStatement === undefined)
		this.Concurrent.Thread.Compiler.BreakStatement = undefined;
	if (this.Concurrent.Thread.Compiler.ReturnStatement === undefined)
		this.Concurrent.Thread.Compiler.ReturnStatement = undefined;
	if (this.Concurrent.Thread.Compiler.WithStatement === undefined)
		this.Concurrent.Thread.Compiler.WithStatement = undefined;
	if (this.Concurrent.Thread.Compiler.SwitchStatement === undefined)
		this.Concurrent.Thread.Compiler.SwitchStatement = undefined;
	if (this.Concurrent.Thread.Compiler.CaseClause === undefined)
		this.Concurrent.Thread.Compiler.CaseClause = undefined;
	if (this.Concurrent.Thread.Compiler.DefaultClause === undefined)
		this.Concurrent.Thread.Compiler.DefaultClause = undefined;
	if (this.Concurrent.Thread.Compiler.ThrowStatement === undefined)
		this.Concurrent.Thread.Compiler.ThrowStatement = undefined;
	if (this.Concurrent.Thread.Compiler.TryCatchStatement === undefined)
		this.Concurrent.Thread.Compiler.TryCatchStatement = undefined;
	if (this.Concurrent.Thread.Compiler.TryFinallyStatement === undefined)
		this.Concurrent.Thread.Compiler.TryFinallyStatement = undefined;
	if (this.Concurrent.Thread.Compiler.TryCatchFinallyStatement === undefined)
		this.Concurrent.Thread.Compiler.TryCatchFinallyStatement = undefined;
	if (this.Concurrent.Thread.Compiler.TryCatchListStatement === undefined)
		this.Concurrent.Thread.Compiler.TryCatchListStatement = undefined;
	if (this.Concurrent.Thread.Compiler.TryCatchListFinallyStatement === undefined)
		this.Concurrent.Thread.Compiler.TryCatchListFinallyStatement = undefined;
	if (this.Concurrent.Thread.Compiler.CatchGuard === undefined)
		this.Concurrent.Thread.Compiler.CatchGuard = undefined;
	if (this.Concurrent.Thread.Compiler.FunctionDeclaration === undefined)
		this.Concurrent.Thread.Compiler.FunctionDeclaration = undefined;
	with (function() {
		with (Data.Cons) {
			with (Concurrent.Thread.Compiler) {
				...
				return function() {
					...
					proto.toString = function() {
						...
						return [labelsToString.call(this), "var ", buf.join(", "), ";",].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "if (", this.cond, ") ", this.body].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "if (", this.cond, ") ", this.tbody, "\n", "else ",
								this.fbody].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "do ", this.body, " while (", this.cond, ");"].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "while (", this.cond, ") ", this.body].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for (", this.init ? this.init : "", "; ",
								this.cond ? this.cond : "", "; ", this.incr ? this.incr : "", ") ", this.body].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for (",
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for (", this.lhs, " in ", this.exp, ") ", this.body]
								.join("");
					};
					...
					proto.toString = function() {
						return [
								labelsToString.call(this),
								"for ( var ",
								this.decl.exp
										? String(this.decl.id) + "=" + String(this.decl.exp)
										: String(this.decl.id), " in ", this.exp, ") ", this.body].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for each (", this.lhs, " in ", this.exp, ") ", this.body]
								.join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "return ", this.exp ? this.exp : "", ";"].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "throw ", this.exp, ";"].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "try ", this.tryBlock, "\n", "catch (", this.variable, ") ",
								this.catchBlock].join("");
					};
					...
					function TryCatchFinallyStatement(labels, tryBlock, variable, catchBlock, finallyBlock, lineno,
							source) {
						Statement.call(this, labels, lineno, source);
						this.tryBlock = tryBlock; // Block
						this.variable = variable; // Identifier
					...
					proto.toString = function() {
						return [labelsToString.call(this), "try ", this.tryBlock, "\n", "catch (", this.variable, ") ",
								this.catchBlock, "\n", "finally ", this.finallyBlock].join("");
					};
					...
					proto.toString = function() {
						var buf = [labelsToString.call(this), "try ", this.tryBlock, "\n"];
					...
					proto.toString = function() {
						var buf = ["function ", this.name, " (", this.params.join(", "), ") {\n"];
						this.body.forEach(function(it) {
							buf.push(it, "\n");
						});
						buf.push("}");
					...
					return {
						...
						Statement : Statement,
						ForInVarStatement : ForInVarStatement,
						BreakStatement : BreakStatement,
						TryCatchListStatement : TryCatchListStatement,
						DoWhileStatement : DoWhileStatement,
						ForInStatement : ForInStatement,
						DefaultClause : DefaultClause,
						VarStatement : VarStatement,
						ContinueStatement : ContinueStatement,
						TryCatchListFinallyStatement : TryCatchListFinallyStatement,
						WhileStatement : WhileStatement,
						SwitchStatement : SwitchStatement,
						ForEachVarStatement : ForEachVarStatement,
...
(function() {
	...
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (this.Concurrent.Thread.Compiler.IdentifierMap === undefined)
		this.Concurrent.Thread.Compiler.IdentifierMap = undefined;
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				...
				proto.clone = function clone() {
					...
					for (var i in this._map) {
						if (hasOwnProperty.call(this._map, i))
							c._map[i] = this._map[i];
					}
					return c;
				};
				...
				proto.exists = function( /* variable arguments */) {
					for (var i = 0; i < arguments.length; i++) {
						...
						if (!(key instanceof Identifier))
							throw new TypeError("arguments[" + i + "] is not of type Identifier");
						if (!hasOwnProperty.call(this._map, key.valueOf()))
							return false;
					}
					return true;
				};
				...
				proto.get = function(k) {
					if (!(k instanceof Identifier))
						throw new TypeError("arguments[0] is not of type Identifier");
					var s = k.valueOf();
					if (!hasOwnProperty.call(this._map, s))
						return undefined;
...
(function() {
	...
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (this.Concurrent.Thread.Compiler.TokenStream === undefined)
		this.Concurrent.Thread.Compiler.TokenStream = undefined;
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				 ...
				 * the Original Code is Netscape Communications Corporation. Portions created by the Initial Developer
				 * are Copyright (C) 1997-1999 the Initial Developer. All Rights Reserved. Contributor(s): Roger
				 * Lawrence Mike McCabe Igor Bukanov Ethan Hugg Terry Lucas Milen Nankov Daisuke Maki Alternatively, the
				 * contents of this file may be used under the terms of the GNU General Public License Version 2 or
				 * later (the "GPL"), in which case the provisions of the GPL are applicable instead of those above. If
				 * you wish to allow use of your version of this file only under the terms of the GPL and not to allow
				 * others to use your version of this file under the MPL, indicate your decision by deleting the
				 * provisions above and replacing them with the notice and other provisions required by the GPL. If you
				 * do not delete the provisions above, a recipient may use your version of this file under either the
				 * MPL or the GPL. ***** END LICENSE BLOCK *****
				 */
				...
				/*
				 * For chars - because we need something out-of-range to check. (And checking EOF by exception is
				 * annoying.) Fortunatelly, U+FFFF is guaranteed not to be assigned for any character. Note distinction
				 * from EOF token type!
				 */
				...
				/*
				 * This function uses the cached op, string and number fields in TokenStream; if getToken has been
				 * called since the passed token was scanned, the op or string printed may be incorrect.
				 */
					...
					retry : for (;;) {
						...
						if (isDigit(c) || (c === '.' && isDigit(this.peekChar()))) {
							...
							if (base === 16) {
								...
								while (isDigit(c)) {
									/*
									 * We permit 08 and 09 as decimal numbers, which makes our behavior a superset of
									 * the ECMA numeric grammar. We might not always be so permissive, so we warn about
									 * it.
									 */
									if (base === 8 && (c === '8' || c === '9')) {
										...
										case 0x21 : // '!'
											...
											switch (c.charCodeAt(0)) {
												case 0x2D : // '-'
													...
													break;
												case 0x5B : // '['
													if (this.getChar() === 'C' && this.getChar() === 'D'
															&& this.getChar() === 'A' && this.getChar() === 'T'
															&& this.getChar() === 'A' && this.getChar() === '[') {
				...
				proto.getChar = function() {
					if (this.ungetBuffer.length)
						return this.ungetBuffer.pop();
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.CssConvert === undefined)
		this.Concurrent.Thread.Compiler.CssConvert = undefined;
	with (function() {
		with (Data.Cons) {
			with (Concurrent.Thread.Compiler) {
				...
				return function() {
					...
					IfStatement.prototype[Css] = function() {
						return new IfStatement(this.labels, this.cond[Css](), this.body[Css](), this.lineno,
							this.source);
					};

					IfElseStatement.prototype[Css] = function() {
						return new IfElseStatement(this.labels, this.cond[Css](), this.tbody[Css](), this.fbody[Css](),
							this.lineno, this.source);
					};

					DoWhileStatement.prototype[Css] = function() {
						return new DoWhileStatement(this.labels, this.body[Css](), this.cond[Css](), this.lineno,
							this.source);
					};

					WhileStatement.prototype[Css] = function() {
						return new WhileStatement(this.labels, this.cond[Css](), this.body[Css](), this.lineno,
							this.source);
					};

					ForStatement.prototype[Css] = function() {
						return new ForStatement(this.labels, this.init ? this.init[Css]() : null, this.cond
									? this.cond[Css]()
									: null, this.incr ? this.incr[Css]() : null, this.body[Css](), this.lineno,
							this.source);
					};
					...
					ForVarStatement.prototype[Css] = function() {
						...
						return new ForVarStatement(this.labels, decls, this.cond ? this.cond[Css]() : null, this.incr
									? this.incr[Css]()
									: null, this.body[Css](), this.lineno, this.source);
					};

					ForInStatement.prototype[Css] = function() {
						return new ForInStatement(this.labels, this.lhs[Css](), this.exp[Css](), this.body[Css](),
							this.lineno, this.source);
					};
					...
					ForInVarStatement.prototype[Css] = function() {
						...
						return new ForInVarStatement(this.labels, decl, this.exp[Css](), this.body[Css](), this.lineno,
							this.source);
					};

					ForEachStatement.prototype[Css] = function() {
						return new ForEachStatement(this.labels, this.lhs[Css](), this.exp[Css](), this.body[Css](),
							this.lineno, this.source);
					};
					...
					ForEachVarStatement.prototype[Css] = function() {
						...
						return new ForEachVarStatement(this.labels, decl, this.exp[Css](), this.body[Css](),
							this.lineno, this.source);
					};
					...
					WithStatement.prototype[Css] = function() {
						return new WithStatement(this.labels, this.exp[Css](), this.body[Css](), this.lineno,
							this.source);
					};
					...
					TryCatchStatement.prototype[Css] = function() {
						return new TryCatchStatement(this.labels, this.tryBlock[Css](), this.variable,
							this.catchBlock[Css](), this.lineno, this.source);
					};

					TryFinallyStatement.prototype[Css] = function() {
						return new TryFinallyStatement(this.labels, this.tryBlock[Css](), this.finallyBlock[Css](),
							this.lineno, this.source);
					};

					TryCatchFinallyStatement.prototype[Css] = function() {
						return new TryCatchFinallyStatement(this.labels, this.tryBlock[Css](), this.variable,
							this.catchBlock[Css](), this.finallyBlock[Css](), this.lineno, this.source);
					};
					...
					TryCatchListStatement.prototype[Css] = function() {
						if (this.catchList.isNil()) { // no more catch-guard
							...
							return new TryCatchStatement(this.labels, this.tryBlock[Css](), guard.variable, new Block(
									[], list(new IfElseStatement([], guard.cond[Css](), guard.block[Css](),
											(new TryCatchListStatement([], new Block([], list(new ThrowStatement([],
														guard.variable))), this.catchList.cdr,
												this.catchList.cdr.lineno, this.cdr.cdr.source))[Css](), guard.lineno,
											guard.source))));
						} else { // (only one) default catch-guard
							var guard = this.catchList.car;
							return new TryCatchStatement(this.labels, this.tryBlock[Css](), guard.variable,
								guard.block[Css](), this.lineno, this.source);
						}
					};

					TryCatchListFinallyStatement.prototype[Css] = function() {
						return new TryFinallyStatement(this.labels, new Block([], list((new TryCatchListStatement([],
										this.tryBlock, this.catchList, this.lineno, this.source))[Css]()), this.lineno,
								this.source), this.finallyBlock[Css](), this.lineno, this.source);
					};
					...
					FunctionDeclaration.prototype[Css] = function() {
						...
						return new FunctionDeclaration(this.labels, this.name, this.params, head.cdr, this.lineno,
							this.source);
					};
					...
					Literal.prototype[Css] = Identifier.prototype[Css] = ThisExpression.prototype[Css] = Elision.prototype[Css] = function() {
						return this;
					};
					...
					ObjectInitializer.prototype[Css] = function() {
						...
						for (var i = 0; i < this.pairs.length; i++) {
							pairs[i] = {
								prop : this.pairs[i].prop,
								exp : this.pairs[i].exp[Css]()
							};
						}
					...
					NewExpression.prototype[Css] = CallExpression.prototype[Css] = function() {
						var args = [];
...
(function() {
	...
	if (!this.Concurrent.Thread.Compiler
			|| (typeof this.Concurrent.Thread.Compiler != 'object' && typeof this.Concurrent.Thread.Compiler != 'function'))
		this.Concurrent.Thread.Compiler = new Object();
	if (!this.Concurrent.Thread.Compiler.IntermediateLanguage
			|| (typeof this.Concurrent.Thread.Compiler.IntermediateLanguage != 'object' && typeof this.Concurrent.Thread.Compiler.IntermediateLanguage != 'function'))
		this.Concurrent.Thread.Compiler.IntermediateLanguage = new Object();
	if (!this.Data || (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.Function === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.Function = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.Block === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.Block = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.GotoBlock === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.GotoBlock = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.CallBlock === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.CallBlock = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.NewBlock === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.NewBlock = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.Statement === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.Statement = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.ExpStatement === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.ExpStatement = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.CondStatement === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.CondStatement = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.RecvStatement === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.RecvStatement = undefined;
	if (this.Concurrent.Thread.Compiler.IntermediateLanguage.EnumStatement === undefined)
		this.Concurrent.Thread.Compiler.IntermediateLanguage.EnumStatement = undefined;
	with (function() {
		with (Data.Cons.Util) {
			with (Data.Cons) {
				with (Concurrent.Thread.Compiler.IntermediateLanguage) {
					...
					return function() {
						 ...
						 * IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the
						 * specific language governing rights and limitations under the License. The Original Code is
						 * Concurrent.Thread code. The Initial Developer of the Original Code is Daisuke Maki. Portions
						 * created by the Initial Developer are Copyright (C) 2006-2007 the Initial Developer. All
						 * Rights Reserved. Contributor(s): Alternatively, the contents of this file may be used under
						 * the terms of either the GNU General Public License Version 2 or later (the "GPL"), or the GNU
						 * Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the provisions
						 * of the GPL or the LGPL are applicable instead of those above. If you wish to allow use of
						...
						proto.toString = function() {
							return [this.id, "([", this.scopes.join(", "), "], ", stringify(this.exception), "): {\n",
									this.body.join("\n").replace(/^/mg, "  "), "\n", "  call ", this.this_val, ".",
									this.func, "(", this.args.join(", "), ") -> ", stringify(this.target), "\n", "}"]
									.join("");
						};
						...
						proto.toString = function() {
							return [this.id, "([", this.scopes.join(", "), "], ", stringify(this.exception), "): {\n",
									this.body.join("\n").replace(/^/mg, "  "), "\n", "  new ", this.func, "(",
									this.args.join(", "), ") -> ", stringify(this.target), "\n", "}"].join("");
						};
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (this.Concurrent.Thread.Compiler.CuConvert === undefined)
		this.Concurrent.Thread.Compiler.CuConvert = undefined;
	with (function() {
		with (Data.Cons) {
			with (Concurrent.Thread) {
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						function unify_block(block, map) {
							...
							if (can_unify(block)) {
								...
								switch (next.constructor) {
									case IL.GotoBlock :
										unified = new IL.GotoBlock(next.scopes, next.body, next.arg, next.target,
											next.exception);
										break;
									case IL.CallBlock :
										unified = new IL.CallBlock(next.scopes, next.body, next.this_val, next.func,
											next.args, next.target, next.exception);
										break;
									case IL.NewBlock :
										unified = new IL.NewBlock(next.scopes, next.body, next.func, next.args,
											next.target, next.exception);
										break;
									default :
										throw new Error("Concurrent.Thread.Compiler.CuConvert: internal error");
								}
								unified.body = concat_list(block.body, next.body);
								if (unified.target instanceof IL.Block && map.hasOwnProperty(unified.target.id)
										&& map[unified.target.id] instanceof Array) {
						...
						function can_unify(block) {
							if (!(block instanceof IL.GotoBlock))
								return false;
							var next = block.target;
							if (!(next instanceof IL.Block))
								return false;
							if (block === next)
								return false;
							if (block.exception !== next.exception)
								return false;
							if (block.scopes.length !== next.scopes.length)
								return false;
							var length = block.exception.length;
							for (var i = 0; i < length; i++) {
								if (block.scopes[i] !== next.scopes[i])
									return false;
							}
							return true;
						}
						...
						function replace_target(base, prop, map) {
							...
							if (!(target instanceof IL.Block)) {
								throw new Error(NAMESPACE + ".CuConvert: internal error - `" + target
										+ "' is not of type IntermediateLanguage.Block");
							}
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.CzConvert === undefined)
		this.Concurrent.Thread.Compiler.CzConvert = undefined;
	with (function() {
		with (Data.Cons.Util) {
			with (Data.Cons) {
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						function CzConvert(func) {
							...
							return new FunctionExpression(null, [var_this, var_args, var_cont],
								list(new ReturnStatement([], new CallExpression(new DotAccessor(body, name_apply), [
													var_this, var_args]))));
						}
						...
						function inner_function(func) {
							var blocks = func.body.map(function(it) {
								return it[Cz]();
							});
							blocks = cons(var_declaration(func.vars), cons(null_function, cons(make_assign(var_args,
											name_arguments), cons(make_assign(arguments_callee, var_self), blocks))));
						...
						function make_return(continuation, ret_val) {
							return new ReturnStatement([], new ObjectInitializer([{
											prop : name_continuation,
											exp : target_to_name(continuation)
										}, {
											prop : name_ret_val,
											exp : ret_val || undefinedExp
										}, {
											prop : name_timeout,
											exp : undefinedExp
										}]));
						...
						function make_continuation(block, body) {
							...
							return new VarStatement([], [{
								...
								exp : new ObjectInitializer([{
									prop : name_procedure,
									exp : new FunctionExpression(null, [var_intermediate], list(assign_arguments, body))
								}, {
									prop : name_this_val,
									exp : new ThisExpression()
								}, {
									prop : name_exception,
									exp : target_to_name(block.exception)
								}])
							}]);
						}
						...
						IL.CallBlock.prototype[Cz] = function() {
							...
							body = cons(null, body);
							adder(body)(new IfElseStatement([], new AndExpression(this.func,
									new StrictEqualExpression(new TypeofExpression(new DotAccessor(this.func,
												var_compiled)), string_function)), new ReturnStatement([],
									new CallExpression(new DotAccessor(this.func, var_compiled), [this.this_val,
												new ArrayInitializer(this.args), target_to_name(this.target)])),
								make_return(this.target, new CallExpression(this.func, this.args))));
							return make_continuation(this, body.cdr);
						};
						...
						IL.NewBlock.prototype[Cz] = function() {
							 ...
							 * CONSTRUCTOR.$Concurrent_Thread_compiled( $Concurrent_Thread_this, [ARG1, ARG2, ...], {
							 * procedure: function($Concurrent_Thread_intermediate){ if (
							 * !($Concurrent_Thread_intermediate && (typeof $Concurrent_Thread_intermediate === "object" ||
							 * typeof $Concurrent_Thread_intermediate === "function") ) $Concurrent_Thread_intermediate =
							 * $Concurrent_Thread_this; $Concurrent_Thread_this = null; // encourages GC return {
							 * continuation: CONTINUATION, ret_val : $Concurrent_Thread_intermediate, timeout : void 0 }; },
							 * this_val: this, exception: EXCEPTION } ); } else { return { continuation: CONTINUATION,
							 * ret_val : new CONSTRUCTOR(ARG1, ARG2...), timeout : void 0 }; }
							 */
							adder(body)(new IfElseStatement([], new AndExpression(this.func,
									new StrictEqualExpression(new TypeofExpression(new DotAccessor(this.func,
												var_compiled)), string_function)), new Block([], list(make_assign(
										new DotAccessor(var_null_function, name_prototype), new DotAccessor(this.func,
											name_prototype)), make_assign(var_this, new NewExpression(
											var_null_function, [])), new ReturnStatement([], new CallExpression(
											new DotAccessor(this.func, var_compiled), [var_this,
													new ArrayInitializer(this.args), new ObjectInitializer([{
														prop : name_procedure,
																	...
																	new NotExpression(new AndExpression(
																			...
																			new OrExpression(
																				new StrictEqualExpression(
																					new TypeofExpression(var_intermediate),
																					string_object),
																				new StrictEqualExpression(
																					new TypeofExpression(var_intermediate),
																					string_function)))), make_assign(
																		var_intermediate, var_this)), make_assign(
																	var_this, new NullLiteral()), make_return(
																	this.target, var_intermediate)))
													}, {
														prop : name_this_val,
														exp : new ThisExpression()
													}, {
														prop : name_exception,
														exp : target_to_name(this.exception)
													}])])))), make_return(this.target, new NewExpression(this.func,
										this.args))));
							return make_continuation(this, body.cdr);
						};
						...
						IL.EnumStatement.prototype[Cz] = function() {
							return new Block([], list(make_assign(var_this, new ArrayInitializer([])),
									new ForInStatement([], var_intermediate, this.exp,
										new ExpStatement([], new CallExpression(new DotAccessor(var_this, name_push),
												[var_intermediate]))), make_assign(this.assignee, var_this),
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (this.Concurrent.Thread.Compiler.CfConvert === undefined)
		this.Concurrent.Thread.Compiler.CfConvert = undefined;
	if (this.Concurrent.Thread.Compiler.CyclicExceptionHandlerError === undefined)
		this.Concurrent.Thread.Compiler.CyclicExceptionHandlerError = undefined;
	with (function() {
		with (Data.Cons.Util) {
			with (Data.Cons) {
				with (Data.Error) {
					with (Concurrent.Thread) {
						with (Concurrent.Thread.Compiler) {
							...
							return function() {
								...
								/***************************************************************************************
								 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL 2.1 The contents of this file
								 * are subject to the Mozilla Public License Version 1.1 (the "License"); you may not
								 * use this file except in compliance with the License. You may obtain a copy of the
								 * License at http://www.mozilla.org/MPL/ Software distributed under the License is
								 ...
								 * under the License. The Original Code is Concurrent.Thread code. The Initial Developer
								 * of the Original Code is Daisuke Maki. Portions created by the Initial Developer are
								 * Copyright (C) 2006-2007 the Initial Developer. All Rights Reserved. Contributor(s):
								 * Alternatively, the contents of this file may be used under the terms of either the
								 * GNU General Public License Version 2 or later (the "GPL"), or the GNU Lesser General
								 * Public License Version 2.1 or later (the "LGPL"), in which case the provisions of the
								 * GPL or the LGPL are applicable instead of those above. If you wish to allow use of
								 * your version of this file only under the terms of either the GPL or the LGPL, and not
								 * to allow others to use your version of this file under the terms of the MPL, indicate
								 * your decision by deleting the provisions above and replace them with the notice and
								 * other provisions required by the GPL or the LGPL. If you do not delete the provisions
								...
								function cacheToList(cache) {
									...
									cache.values().forEach(function(it) {
										blocks.push(it);
										depends.put(new Identifier(it.id), it.exception instanceof IL.Block
													? new Identifier(it.exception.id)
													: undefined);
									});
									return check_cyclic(depends);
								}

								var CyclicExceptionHandlerError = Error.extend(function($super, message) {
									$super(message);
								}, {
									...
									function traverse(id, path) {
										...
										path.forEach(function(it) {
											if (it.valueOf() == id.valueOf()) {
												throw new CyclicExceptionHandlerError("cyclic exception handler: "
														+ path.concat([id]).join(" -> "));
											}
										});
										path.push(id);
								...
								function CfTarget(b, cache) {
									if (b === "return" || b === "throw")
										return b;
									if (cache.get(new Identifier(b.id)))
								...
								IL.GotoBlock.prototype[Cf] = function(cache) {
									...
									block.scopes = this.scopes.map(function(it) {
										return it[Cf](cache);
									});
									block.body = this.body.map(function(it) {
										return it[Cf](cache);
									});
								...
								IL.CallBlock.prototype[Cf] = function(cache) {
									...
									block.args = this.args.map(function(it) {
										return it[Cf](cache);
									});
									block.target = CfTarget(this.target, cache);
									block.exception = CfTarget(this.exception, cache);
								...
								IL.ExpStatement.prototype[Cf] = function(cache) {
									return new IL.ExpStatement(this.exp[Cf](cache));
								};

								IL.CondStatement.prototype[Cf] = function(cache) {
									return new IL.CondStatement(this.cond[Cf](cache), CfTarget(this.target, cache));
								};

								IL.RecvStatement.prototype[Cf] = function(cache) {
									return new IL.RecvStatement(this.assignee[Cf](cache));
								};

								IL.EnumStatement.prototype[Cf] = function(cache) {
									return new IL.EnumStatement(this.exp[Cf](cache), this.assignee[Cf](cache));
								};
								...
								ConditionalExpression.prototype[Cf] = function(cache) {
									return new ConditionalExpression(this.cond[Cf](cache), this.texp[Cf](cache),
										this.fexp[Cf](cache));
								};

								return {
									CfConvert : CfConvert,
									CyclicExceptionHandlerError : CyclicExceptionHandlerError
								};
							}();
						}
					}
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.Parser === undefined)
		this.Concurrent.Thread.Compiler.Parser = undefined;
	with (function() {
		with (Data.Cons) {
			with (Data) {
				with (Data.Error) {
					with (Concurrent.Thread.Compiler) {
						...
						return function() {
							...
							/*******************************************************************************************
							 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0 The contents of this file are subject
							 * to the Mozilla Public License Version 1.1 (the "License"); you may not use this file
							 * except in compliance with the License. You may obtain a copy of the License at
							 * http://www.mozilla.org/MPL/ Software distributed under the License is distributed on an
							 * "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License
							 * for the specific language governing rights and limitations under the License. The
							 * Original Code is Rhino code, released May 6, 1999. The Initial Developer of the Original
							 * Code is Netscape Communications Corporation. Portions created by the Initial Developer
							 * are Copyright (C) 1997-1999 the Initial Developer. All Rights Reserved. Contributor(s):
							 * Mike Ang Igor Bukanov Yuh-Ruey Chen Ethan Hugg Terry Lucas Mike McCabe Milen Nankov
							 * Daisuke Maki Alternatively, the contents of this file may be used under the terms of the
							 * GNU General Public License Version 2 or later (the "GPL"), in which case the provisions
							 * of the GPL are applicable instead of those above. If you wish to allow use of your
							 * version of this file only under the terms of the GPL and not to allow others to use your
							 * version of this file under the MPL, indicate your decision by deleting the provisions
							 * above and replacing them with the notice and other provisions required by the GPL. If you
							 * do not delete the provisions above, a recipient may use your version of this file under
							 * either the MPL or the GPL. ***** END LICENSE BLOCK *****
							 */
							...
							// Exception to unwind
							var ParserException = Exception.extend(function($super, message) {
								$super(message);
							}, {
							...
							proto.addWarning = function(messageId /* optional args */) {
								this.errorReporter.warning(this.getMessage.apply(this, arguments), this.ts.getLineno(),
									this.ts.getLine(), this.ts.getOffset());
							};

							proto.addError = function(messageId /* optional args */) {
								++this.syntaxErrorCount;
								this.errorReporter.error(this.getMessage.apply(this, arguments), this.ts.getLineno(),
									this.ts.getLine(), this.ts.getOffset());
							};
							...
							proto.peekTokenOrEOL = function() {
								...
								if (this.flaggedTokenBuffer.peek() & TI_AFTER_EOL)
									return Token.EOL;
								return tt;
							};
							...
							proto.setCheckForLabel = function() {
								...
								if ((tt & CLEAR_TI_MASK) !== Token.NAME)
									throw Kit.codeBug();
							...
							proto.enterLoop = function(labels) {
								for (var i = 0; i < labels.length; i++)
									this.loopLabelSet.add(labels[i]);
								this.nestingOfLoop++;
							};

							proto.exitLoop = function(labels) {
								for (var i = 0; i < labels.length; i++)
									this.loopLabelSet.remove(labels[i]);
								this.nestingOfLoop--;
							};
							...
							proto.functionExpr = function() {
								...
								if (this.matchToken(Token.NAME))
									name = new Identifier(this.ts.getString());
								var params = this.parameterList();
								var body = this.functionBody();
								...
								switch (this.peekToken()) {
									case Token.IF : {
										...
										if (this.matchToken(Token.ELSE)) {
											return new IfElseStatement(labels, cond, tstat, this.statement(), lineno,
												this.source);
										} else {
									...
									case Token.SWITCH : {
										...
										var switchStatement = new SwitchStatement(labels, exp, nil(), lineno,
											this.source);
										...
										try {
											...
											switchLoop : for (;;) {
												...
												var c = caseExpression
														? new CaseClause(caseExpression, this.statementsInSwitch(),
															lineno, this.source)
														: new DefaultClause(this.statementsInSwitch(), lineno,
															this.source);
									...
									case Token.WHILE : {
										...
										try {
											return new WhileStatement(labels, this.condition(), this.statement(),
												lineno, this.source);
										} finally {
									...
									case Token.FOR : {
										...
										if (!isForIn) {
											...
											if (isVar)
												return new ForVarStatement(labels, init, cond, incr, body, lineno,
													this.source);
											else
												return new ForStatement(labels, init, cond, incr, body, lineno,
													this.source);
										} else {
											if (isVar) {
												...
												if (isForEach)
													return new ForEachVarStatement(labels, init[0], cond, body, lineno,
														this.source);
												else
													return new ForInVarStatement(labels, init[0], cond, body, lineno,
														this.source);
											} else {
												...
												if (isForEach)
													return new ForEachStatement(labels, init, cond, body, lineno,
														this.source);
												else
													return new ForInStatement(labels, init, cond, body, lineno,
														this.source);
											}
										}
									}
									...
									case Token.TRY : {
										...
										if (!(tryBlock instanceof Block)) {
											...
											tryBlock = new Block([], cons(tryBlock, nil()), tryBlock.lineno,
												tryBlock.source);
										}
										...
										if (this.matchToken(Token.FINALLY)) {
											...
											if (!(finallyBlock instanceof Block)) {
												...
												finallyBlock = new Block([], cons(finallyBlock, nil()),
													finallyBlock.lineno, finallyBlock.source);
											}
										}

										return finallyBlock ? new TryCatchListFinallyStatement(labels, tryBlock,
											catchList, finallyBlock, lineno, this.source) : new TryCatchListStatement(
											labels, tryBlock, catchList, lineno, this.source);
									}
									...
									case Token.BREAK : {
										...
										if (target == null) {
											if (!this.nestingOfLoop && !this.nestingOfSwitch)
									...
									case Token.NAME : {
										...
										try {
											...
											if (e instanceof LabelException) {
												// Label found!
												if (this.allLabelSet.contains(e.label))
							...
							proto.condition = function() {
								...
								if (exp instanceof SimpleAssignExpression)
									this.addWarning("msg.assign.cond");
								return exp;
							};

							// match a NAME; return null if no match.
							proto.matchJumpLabelName = function(token) {
								if (this.peekTokenOrEOL() !== Token.NAME)
									return null;
							...
							proto.variables = function(inForInit) {
								...
								for (;;) {
									...
									var name = new Identifier(this.ts.getString());
									var init = this.matchToken(Token.ASSIGN) ? this.assignExpr(inForInit) : null;
									decls.push({
										id : name,
										exp : init
									});
							...
							proto.assignExpr = function(inForInit) {
								...
								var tt = this.peekToken();
								if (tt < Token.FIRST_ASSIGN || Token.LAST_ASSIGN < tt)
									return exp;
							...
							proto.unaryExpr = function() {
								...
								switch (this.peekToken()) {
									...
									default :
										...
										switch (this.peekTokenOrEOL()) {
											case Token.INC :
												if (!exp.hasLvalue())
													this.reportError("msg.bad.incr");
												this.consumeToken();
												return new PostIncExpression(exp);
											case Token.DEC :
												if (!exp.hasLvalue())
													this.reportError("msg.bad.decr");
												this.consumeToken();
								...
								this.consumeToken();
								var exp = this.unaryExpr();
								if (needLvalue && !exp.hasLvalue())
									this.reportError(needLvalue);
							...
							proto.memberExpr = function(allowCallSyntax) {
								...
								if (this.matchToken(Token.NEW)) {
									...
									var args = this.matchToken(Token.LP) ? this.argumentList() : [];
								...
								switch (tt) {
									...
									case Token.NAME :
										...
										if (ttFlagged & TI_CHECK_LABEL) {
											if (this.matchToken(Token.COLON))
												throw new LabelException(name);
										}
										return name;
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.CsConvert === undefined)
		this.Concurrent.Thread.Compiler.CsConvert = undefined;
	with (function() {
		with (Data.Functional) {
			with (Data.Cons) {
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						function isStackVar(v) {
							return v instanceof Identifier && v.valueOf().match(/^$Concurrent_Thread_stack/);
						}
						...
						proto.getStackVar = function(n) {
							n = Math.floor(n);
							if (isNaN(n) || n < 0)
								Kit.codeBug("must be integer greater than zero");
						...
						IfStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							...
							try {
								...
								follows.car.prependStatement(new IL.CondStatement(new NotExpression(ctxt
											.getStackVar(sttop)), next_block));
						...
						DoWhileStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							...
							if (this.cond.containsFunctionCall()) {
								follows.car
										.prependStatement(new IL.CondStatement(ctxt.getStackVar(sttop), first_block));
							...
							follows = cons(ctxt.makeGotoBlock(undefinedExp, follows.car), follows);
							var restore = ctxt.putBreakAndContinueLabels(this.labels.concat(emptyLabel), next_block,
								continue_block);
							try {
								follows = this.body[Cs](follows, ctxt, sttop);
							} finally {
							...
							return cons(ctxt.makeGotoBlock(undefinedExp, first_block), cons(first_block, follows));
						};
						...
						WhileStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							...
							if (this.cond.containsFunctionCall()) {
								...
								follows.car.prependStatement(new IL.CondStatement(new NotExpression(this.cond),
									next_block));
							}
							first_block.target = follows.car;
							return cons(ctxt.makeGotoBlock(undefinedExp, first_block), cons(first_block, follows));
						...
						ForStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							...
							if (this.incr)
								follows = this.incr[Cs](follows, ctxt, sttop, true);
						...
						ForInStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							if (!this.lhs.hasLvalue())
								Kit.codeBug('for-in requires lvalue on the left hand side of "in": ' + this);
							var next_block = follows.car;
							...
							if (this.lhs.containsFunctionCall()) {
								follows = CsReference(this.lhs, ctxt, sttop + 2, function(exp) {
									follows.car.prependStatement(make_assign(exp,
										new BracketAccessor(ctxt.getStackVar(sttop), new PostIncExpression(ctxt
													.getStackVar(sttop + 1)))));
									return follows;
								});
							} else {
								follows.car.prependStatement(make_assign(this.lhs,
									new BracketAccessor(ctxt.getStackVar(sttop), new PostIncExpression(ctxt
												.getStackVar(sttop + 1)))));
							}
							follows.car.prependStatement(new IL.CondStatement(new GreaterEqualExpression(ctxt
											.getStackVar(sttop + 1), new DotAccessor(ctxt.getStackVar(sttop),
										new Identifier("length"))), next_block));
							loop_block.target = follows.car;
							follows = cons(loop_block, follows);
							follows = cons(ctxt.makeGotoBlock(undefinedExp, loop_block), follows);
							follows.car
									.prependStatement(make_assign(ctxt.getStackVar(sttop + 1), new NumberLiteral(0)));
							if (this.exp.containsFunctionCall()) {
								follows.car.prependStatement(new IL.EnumStatement(ctxt.getStackVar(sttop), ctxt
											.getStackVar(sttop)));
						...
						ContinueStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							return cons(ctxt.makeGotoBlock(undefinedExp, ctxt.contContinue.get(this.target
											? this.target
											: emptyLabel)), follows);
						};
						...
						BreakStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							var restore = ctxt.putBreakLabels(this.labels, follows.car);
							try {
								return cons(ctxt.makeGotoBlock(undefinedExp, ctxt.contBreak.get(this.target
												? this.target
												: emptyLabel)), follows);
							} finally {
								ctxt.contBreak = restore;
						...
						ReturnStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							if (this.exp) {
								if (this.exp.containsFunctionCall()) {
									follows = cons(ctxt.makeGotoBlock(ctxt.getStackVar(sttop), ctxt.contReturn),
										follows);
							...
							try {
								...
								cond_and_target.forEach(function(it) {
									if (it.cond.containsFunctionCall()) {
										follows.car.prependStatement(new IL.CondStatement(new StrictEqualExpression(
													ctxt.getStackVar(sttop), ctxt.getStackVar(sttop + 1)), it.target));
										follows = it.cond[Cs](follows, ctxt, sttop + 1);
									} else {
										follows.car.prependStatement(new IL.CondStatement(new StrictEqualExpression(
													ctxt.getStackVar(sttop), it.cond), it.target));
									}
								});
								return this.exp[Cs](follows, ctxt, sttop);
							} finally {
						...
						TryFinallyStatement.prototype[Cs] = function(follows, ctxt, sttop) {
							...
							try {
								...
								ctxt.contContinue.keys().forEach(function(label) {
									follows = cons(ctxt.makeGotoBlock(undefinedExp, ctxt.contContinue.get(label)),
										follows);
									follows = self.finallyBlock[Cs](follows, ctxt, sttop);
						...
						function prepend_exp(exp, follows, ctxt, sttop, is_void) {
							follows.car.prependStatement(is_void ? new IL.ExpStatement(exp) : make_assign(ctxt
											.getStackVar(sttop), exp));
							return follows;
						}
						...
						ArrayInitializer.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							for (var asis_from = this.elems.length - 1; asis_from >= 0; asis_from--) {
								if (this.elems[asis_from].containsFunctionCall())
									break;
							}
							asis_from++;
							var elems = [];
						...
						ObjectInitializer.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							for (var asis_from = this.pairs.length - 1; asis_from >= 0; asis_from--) {
								if (this.pairs[asis_from].exp.containsFunctionCall())
									break;
							}
							asis_from++;
							var pairs = [];
						...
						UnaryExpression.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							if (this.exp.containsFunctionCall()) {
								follows = prepend_exp(new this.constructor(ctxt.getStackVar(sttop)), follows, ctxt,
									sttop, is_void);
								return this.exp[Cs](follows, ctxt, sttop);
							} else {
						...
						BinaryExpression.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							if (this.right.containsFunctionCall()) {
								follows = prepend_exp(new this.constructor(ctxt.getStackVar(sttop), ctxt
												.getStackVar(sttop + 1)), follows, ctxt, sttop, is_void);
								follows = this.right[Cs](follows, ctxt, sttop + 1);
								return this.left[Cs](follows, ctxt, sttop);
							} else if (this.left.containsFunctionCall()) {
								follows = prepend_exp(new this.constructor(ctxt.getStackVar(sttop), this.right),
									follows, ctxt, sttop, is_void);
								return this.left[Cs](follows, ctxt, sttop);
							} else {
								return Expression.prototype[Cs].apply(this, arguments);
							}
						...
						DotAccessor.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							if (this.base.containsFunctionCall()) {
								follows = prepend_exp(new DotAccessor(ctxt.getStackVar(sttop), this.prop), follows,
									ctxt, sttop, is_void);
						...
						CallExpression.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							...
							return CsReference(this.func, ctxt, sttop, function(func, sttop2) {
								for (var asis_from = self.args.length - 1; asis_from >= 0; asis_from--) {
									if (self.args[asis_from].containsFunctionCall())
										break;
								}
								asis_from++;
								var args = [];
								...
								if (!is_void)
									follows.car.prependStatement(new IL.RecvStatement(ctxt.getStackVar(sttop)));
								follows = cons(new IL.CallBlock(ctxt.getScopes(), nil(), func instanceof DotAccessor
												? func.base
												: func instanceof BracketAccessor ? func.left : new NullLiteral(),
										func, args, follows.car, ctxt.contThrow), follows);
								for (var i = asis_from - 1; i >= 0; i--) {
						...
						NewExpression.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							for (var asis_from = this.args.length - 1; asis_from >= 0; asis_from--) {
								if (this.args[asis_from].containsFunctionCall())
									break;
							}
							asis_from++;
							var args = [];
							...
							if (!is_void)
								follows.car.prependStatement(new IL.RecvStatement(ctxt.getStackVar(sttop)));
							follows = cons(new IL.NewBlock(ctxt.getScopes(), nil(), ctxt.getStackVar(sttop), args,
									follows.car, ctxt.contThrow), follows);
							for (var i = asis_from - 1; i >= 0; i--) {
						...
						AssignExpression.prototype[Cs] = function(follows, ctxt, sttop, is_void) {
							...
							if (this.right.containsFunctionCall()) {
								return CsReference(this.left, ctxt, sttop, function(left, sttop2) {
									follows = prepend_exp(new self.constructor(left, ctxt.getStackVar(sttop2)),
										follows, ctxt, sttop, is_void);
									return self.right[Cs](follows, ctxt, sttop2);
								});
							} else if (this.left.containsFunctionCall()) {
								return CsReference(this.left, ctxt, sttop, function(left, sttop2) {
									return prepend_exp(new self.constructor(left, self.right), follows, ctxt, sttop,
										is_void);
								});
							} else {
								return Expression.prototype[Cs].apply(this, arguments);
						...
						AndExpression.prototype[Cs] = function(follows, ctxt, sttop) {
							if (this.right.containsFunctionCall()) {
								...
								follows.car.prependStatement(make_assign(ctxt.getStackVar(sttop), new AndExpression(
										ctxt.getStackVar(sttop), this.right)));
								return this.left[Cs](follows, ctxt, sttop);
							} else {
								return Expression.prototype[Cs].apply(this, arguments);
							}
						...
						OrExpression.prototype[Cs] = function(follows, ctxt, sttop) {
							if (this.right.containsFunctionCall()) {
								...
								follows.car.prependStatement(make_assign(ctxt.getStackVar(sttop), new OrExpression(ctxt
												.getStackVar(sttop), this.right)));
								return this.left[Cs](follows, ctxt, sttop);
							} else {
								return Expression.prototype[Cs].apply(this, arguments);
							}
						...
						ConditionalExpression.prototype[Cs] = function(follows, ctxt, sttop) {
							if (this.texp.containsFunctionCall() || this.fexp.containsFunctionCall()) {
								...
								follows.car.prependStatement(make_assign(ctxt.getStackVar(sttop),
									new ConditionalExpression(ctxt.getStackVar(sttop), this.texp, this.fexp)));
								return this.cond[Cs](follows, ctxt, sttop);
							} else {
								return Expression.prototype[Cs].apply(this, arguments);
							}
...
(function() {
	...
	if (!this.Data.Cons || (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (this.Concurrent.Thread.Compiler.CvConvert === undefined)
		this.Concurrent.Thread.Compiler.CvConvert = undefined;
	with (function() {
		with (Data.Cons.Util) {
			with (Data.Cons) {
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						ForVarStatement.prototype[Cv] = function(add_vars, add_decls) {
							...
							return new ForStatement(this.labels, init, this.cond, this.incr, this.body[Cv](add_vars,
									add_decls), this.lineno, this.source);
						};
						...
						ForInVarStatement.prototype[Cv] = function(add_vars, add_decls) {
							...
							var for_in = new ForInStatement(this.labels, this.decl.id, this.exp, this.body[Cv](
									add_vars, add_decls), this.lineno, this.source);
							if (this.decl.exp) {
								return new Block([], list(new ExpStatement([], new SimpleAssignExpression(this.decl.id,
												this.decl.exp), this.lineno, this.source), for_in), this.lineno,
									this.source);
							} else {
								return for_in;
							}
						...
						FunctionDeclaration.prototype[Cv] = function(add_vars, add_decls) {
							add_vars(this.name);
							add_decls(new ExpStatement([], new SimpleAssignExpression(this.name,
									new FunctionExpression(null, this.params, this.body)), this.lineno, this.source));
							return new EmptyStatement([]);
						};
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (this.Concurrent.Thread.compile === undefined)
		this.Concurrent.Thread.compile = undefined;
	if (this.Concurrent.Thread.CACHE_LIMIT === undefined)
		this.Concurrent.Thread.CACHE_LIMIT = undefined;
	if (this.Concurrent.Thread.prepare === undefined)
		this.Concurrent.Thread.prepare = undefined;
	if (this.Concurrent.Thread.prepareTree === undefined)
		this.Concurrent.Thread.prepareTree = undefined;
	with (function() {
		with (Data.Cons) {
			with (Concurrent.Thread.Compiler) {
				with (Concurrent.Thread) {
					...
					return function() {
						...
						function parseFunction(f) {
							...
							if (!(stmts.car instanceof ExpStatement))
								throw new Error("not exp-statement!");
							if (!(stmts.car.exp instanceof FunctionExpression))
								throw new Error("not function-expression!");
							return stmts.car.exp;
						}

						function prepareTree(f) {
							if (!(f instanceof FunctionExpression))
								Kit.codeBug("not FunctionalExpression");
							var name = f.name;
							f.name = null;
							var g = CssConvert(f);
							g = CvConvert(g);
							...
							g = CfConvert(g);
							g = CzConvert(g);
							return new CallExpression(new FunctionExpression(null, [], list(new VarStatement([], [{
														id : var_self,
														exp : f
													}]), name ? new VarStatement([], [{
														id : name,
														exp : var_self
													}]) : new EmptyStatement([]), new ExpStatement([],
											new SimpleAssignExpression(new DotAccessor(var_self, var_compiled), g)),
										new ReturnStatement([], var_self))), []);
							/*
							 * Constructs the following structure: "(function(){", " var $Concurrent_Thread_self = ", f,
							 * ";", name ? "var " + name + " = " + "$Concurrent_Thread_self;" : "", "
							 * $Concurrent_Thread_self.$Concurrent_Thread_compiled = ", func, ";", " return
			...
			return function() {
				...
				function compile(src) {
					...
					prog.vars.forEach(function(it) {
						...
						if (!Object.prototype.hasOwnProperty.call(window, it))
							window[it] = undefined;
					});
					prog.vars = [];
					prog = CzConvert(prog);
					return ["1, function(){", "    var $Concurrent_Thread_self = function(){};",
							"    $Concurrent_Thread_self.$Concurrent_Thread_compiled = ", prog, ";",
							"    return $Concurrent_Thread_self;", "}()"].join("");
				}
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (this.Concurrent.Thread.Generator === undefined)
		this.Concurrent.Thread.Generator = undefined;
	with (function() {
		with (Concurrent.Thread.Continuation) {
			with (Concurrent) {
				with (Concurrent.Thread) {
					...
					return function() {
						 ...
						 * IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the
						 * specific language governing rights and limitations under the License. The Original Code is
						 * Concurrent.Thread.Generator module. The Initial Developer of the Original Code is Daisuke
						 * Maki. Portions created by the Initial Developer are Copyright (C) 2008 the Initial Developer.
						 * All Rights Reserved. Contributor(s): Alternatively, the contents of this file may be used
						 * under the terms of either the GNU General Public License Version 2 or later (the "GPL"), or
						 * the GNU Lesser General Public License Version 2.1 or later (the "LGPL"), in which case the
						 * provisions of the GPL or the LGPL are applicable instead of those above. If you wish to allow
						 * use of your version of this file only under the terms of either the GPL or the LGPL, and not
						 * to allow others to use your version of this file under the terms of the MPL, indicate your
						 * decision by deleting the provisions above and replace them with the notice and other
						 * provisions required by the GPL or the LGPL. If you do not delete the provisions above, a
						 * recipient may use your version of this file under the terms of any one of the MPL, the GPL or
						 * the LGPL. ***** END LICENSE BLOCK *****
						...
						proto.hasNext = function() {
							...
							if (!this._mutex.isAcquirable())
								this._mutex.acquire(); // must throw an error
							if (this._got)
								return true;
							if (!this._cont_iter)
								return false;
						...
						proto.hasNext.$Concurrent_Thread_compiled = eval(Thread.prepare(function() {
							this._mutex.acquire();
							try {
								if (this._got)
									return true;
						...
						proto.next = eval(Thread.prepare(function() {
							if (this.hasNext()) {
								var x = this._buf;
								this._buf = void 0;
								this._got = false;
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (!this.Concurrent.Thread.Event
			|| (typeof this.Concurrent.Thread.Event != 'object' && typeof this.Concurrent.Thread.Event != 'function'))
		this.Concurrent.Thread.Event = new Object();
	if (!this.Util || (typeof this.Util != 'object' && typeof this.Util != 'function'))
		this.Util = new Object();
	if (!this.Util.Arrayize || (typeof this.Util.Arrayize != 'object' && typeof this.Util.Arrayize != 'function'))
		this.Util.Arrayize = new Object();
	if (this.Concurrent.Thread.Event.waitFor === undefined)
		this.Concurrent.Thread.Event.waitFor = undefined;
	if (this.Concurrent.Thread.Event.select === undefined)
		this.Concurrent.Thread.Event.select = undefined;
	with (function() {
		with (Util.Arrayize) {
			with (WebBrowser.GUI.Event) {
				with (Concurrent) {
					with (Concurrent.Thread.Event) {
						...
						return function() {
							...
							var waitFor = eval(Concurrent.Thread.prepare(function waitFor(target, type, options) {
								var arg = {};
							...
							var select = eval(Concurrent.Thread.prepare(function select( /* variable args */) {
								try {
									var signal = {};
...
(function() {
	...
	if (!this.Concurrent.Thread
			|| (typeof this.Concurrent.Thread != 'object' && typeof this.Concurrent.Thread != 'function'))
		this.Concurrent.Thread = new Object();
	if (!this.Concurrent.Thread.JSON
			|| (typeof this.Concurrent.Thread.JSON != 'object' && typeof this.Concurrent.Thread.JSON != 'function'))
		this.Concurrent.Thread.JSON = new Object();
	if (!this.Concurrent.Thread.JSON.RPC
			|| (typeof this.Concurrent.Thread.JSON.RPC != 'object' && typeof this.Concurrent.Thread.JSON.RPC != 'function'))
		this.Concurrent.Thread.JSON.RPC = new Object();
	if (!this.JSON || (typeof this.JSON != 'object' && typeof this.JSON != 'function'))
		this.JSON = new Object();
	if (!this.Util || (typeof this.Util != 'object' && typeof this.Util != 'function'))
		this.Util = new Object();
	if (!this.Util.Arrayize || (typeof this.Util.Arrayize != 'object' && typeof this.Util.Arrayize != 'function'))
		this.Util.Arrayize = new Object();
	if (this.Concurrent.Thread.JSON.RPC.bind === undefined)
		this.Concurrent.Thread.JSON.RPC.bind = undefined;
	if (this.Concurrent.Thread.JSON.RPC.JSONRPCError === undefined)
		this.Concurrent.Thread.JSON.RPC.JSONRPCError = undefined;
	with (function() {
		with (Data.Error) {
			with (Util.Arrayize) {
				with (JSON) {
							...
							return function() {
								...
								function bind(opts) {
									if (!(opts instanceof Object))
										throw new TypeError("argument for " + NAMESPACE + ".bind must be a hash.");
									var request = opts.request;
									if (request != null) {
										if (!String(request).match(/^(?:GET|POST)$/i))
											throw new Error('"request" option must be "GET" or "POST".');
									} else {
										request = "POST";
									}
									var params = opts.params;
									if (params != null) {
										if (!String(params).match(/^(?:Named|Positioned)$/i))
											throw new Error('"params" option must be "Named" or "Positioned".');
									} else {
										params = "Named";
									}
									var body;
									...
									if (pre != null) {
										if (typeof pre != "function")
											throw new TypeError('"preprocess" option must be function');
								...
								var COMMON_HEADERS = ['User-Agent', 'Concurrent.Thread.JSON.RPC', 'Accept',
										'application/json'];

								var POST_HEADERS = COMMON_HEADERS.concat('Content-type', 'application/json');

								function makeNamedPost(url, method) {
									return eval(Thread.prepare(function( /* variable arguments */) {
								...
								function makeNamedGet(url, method) {
									...
									return eval(Thread.prepare(function( /* variable arguments */) {
										var res = Thread.Http.get(url + params2query(args2params(arguments)),
											COMMON_HEADERS);
										res = eval("(" + res.responseText + ")");
										if (res.error)
											throw new JSONRPCError(res.error);
								...
								function args2params(args) {
									...
									if (args.length) {
										...
										if (!(hash instanceof Object))
											throw new Error("the last argument must be a hash");
										for (var i in hash) {
								...
								var JSONRPCError = Error.extend(function($super, e) {
