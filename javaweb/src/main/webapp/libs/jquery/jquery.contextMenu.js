if (jQuery)
	(function() {
		$.extend($.fn, {
			 ...
			 * menu
			 */
			contextMenu : function(o, methodname, callback) {
				// Defaults
				if (o.menu == undefined)
					return false;
									...
									switch (e.keyCode) {
										case 38 : // up
											if ($(menu).find('LI.hover').size() == 0) {
												...
												$(menu).find('LI.hover').removeClass('hover')
														.prevAll('LI:not(.disabled)').eq(0).addClass('hover');
												if ($(menu).find('LI.hover').size() == 0)
													$(menu).find('LI:last').addClass('hover');
											}
											break;
										case 40 : // down
											if ($(menu).find('LI.hover').size() == 0) {
												...
												$(menu).find('LI.hover').removeClass('hover')
														.nextAll('LI:not(.disabled)').eq(0).addClass('hover');
												if ($(menu).find('LI.hover').size() == 0)
													$(menu).find('LI:first').addClass('hover');
											}
											break;
